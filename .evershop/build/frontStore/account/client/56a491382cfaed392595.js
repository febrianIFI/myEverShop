...
function AccountInfo({ title, showLogout }) {
    ...
    return (react.createElement("div", { className: "account__details divide-y" },
        react.createElement("div", { className: "flex justify-between items-center border-border" },
            ...
            react.createElement(common_Area, { id: "accountDetails", coreComponents: [
                    {
                        component: {
                            default: (react.createElement("div", { className: "account__details__name flex gap-2 py-2" },
                                react.createElement("div", null,
                                    react.createElement(user/* default */.A, { width: 20, height: 20 })),
                    ...
                    },
                    {
                        component: {
                            default: () => (react.createElement("div", { className: "account__details__email flex gap-2 py-2" },
                                react.createElement("div", null,
                                    react.createElement(mail/* default */.A, { width: 20, height: 20 })),
...
function ItemTitle({ className, ...props }) {
    return (Item_React.createElement("div", { "data-slot": "item-title", className: Item_cn('gap-2 text-sm leading-snug font-medium underline-offset-4 line-clamp-1 flex w-fit items-center', className), ...props }));
}
function ItemDescription({ className, ...props }) {
    return (Item_React.createElement("p", { "data-slot": "item-description", className: Item_cn('text-muted-foreground text-left text-sm leading-normal group-data-[size=xs]/item:text-xs [&>a:hover]:text-primary line-clamp-2 font-normal [&>a]:underline [&>a]:underline-offset-4', className), ...props }));
}
...
const Address = ({ address }) => {
    ...
    return (react.createElement(Item, { variant: 'outline', className: `${classes}` },
                ...
                react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
                    ...
                    react.createElement(DialogContent, null,
                        react.createElement(DialogHeader, null,
                            react.createElement(Dialog_DialogTitle, null, _('Edit Address'))),
                    ...
                    react.createElement(DialogFooter, null,
                        react.createElement(Button_Button, { variant: "destructive", onClick: async (e) => {
                                e.preventDefault();
                                try {
...
function MyAddresses({ title }) {
    ...
    return (react.createElement("div", null,
        ...
        react.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5 mb-3" }, customer.addresses.map((address) => (react.createElement(Address, { key: address.uuid, address: address })))),
        react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
            react.createElement(Dialog_DialogTrigger, null,
                react.createElement(Button_Button, { variant: "outline", onClick: (e) => {
                        e.preventDefault();
            ...
            react.createElement(DialogContent, null,
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, _('Add new address'))),
        ...
        react.createElement("div", { className: "order-inner grid grid-cols-1 md:grid-cols-3 gap-5" },
            react.createElement("div", { className: "order-items col-span-2" }, order.items.map((item) => (react.createElement("div", { className: "order-item mb-2 flex gap-5 items-center", key: item.productSku },
                react.createElement("div", { className: "thumbnail border border-divider p-2 rounded" },
                    item.thumbnail && (react.createElement(Image, { width: 50, height: 50, style: { maxWidth: '6rem' }, src: item.thumbnail, alt: item.productName })),
                    !item.thumbnail && (react.createElement(ProductNoThumbnail, { width: 50, height: 50 }))),
                react.createElement("div", { className: "order-item-info" },
                    ...
                    react.createElement("div", { className: "order-item-sku italic" },
                        ...
                        ": #",
                        item.productSku),
                    react.createElement("div", { className: "order-item-qty" },
                        item.qty,
                        " x ",
...
function OrderHistory({ title }) {
    ...
    return (react.createElement("div", { className: "order-history divide-y" },
        title && react.createElement("h2", { className: "order-history-title border-border" }, title),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(47070)))
