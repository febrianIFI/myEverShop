...
function SheetFooter({ className, ...props }) {
    return (react.createElement("div", { "data-slot": "sheet-footer", className: cn('gap-2 p-4 mt-auto flex flex-col', className), ...props }));
}
...
const DefaultAttributeFilterRender = ({ availableAttributes, currentFilters }) => {
    ...
    return (react.createElement(react.Fragment, null, availableAttributes.map((attribute) => {
        ...
        return (react.createElement("div", { key: attribute.attributeCode, className: "attribute__filter__section border-b border-border pb-2 mb-2" },
            react.createElement("div", { className: "filter__header flex items-center justify-between mb-3" },
                react.createElement("button", { onClick: () => toggleCollapse(attribute.attributeCode), className: "flex items-center justify-between text-left flex-1 hover:text-primary transition-colors" },
                ...
                selectedCount > 0 && (react.createElement(Button_Button, { variant: 'link', onClick: () => clearAttributeFilter(attribute.attributeCode), className: "hover:text-destructive text-sm transition-colors", title: "Clear all" }, "\u2715"))),
            !isCollapsed && (react.createElement("div", { className: "filter__content" },
                attribute.options.length > 5 && (react.createElement("div", { className: "mb-3" },
                    react.createElement(Checkbox, { value: searchTerms[attribute.attributeCode] || '', onCheckedChange: (checked) => setSearchTerms((prev) => ({
                            ...prev,
                ...
                react.createElement("div", { className: "attribute__options space-y-2 max-h-48 overflow-y-auto" }, filteredOptions.length > 0 ? (filteredOptions.map((option) => {
                    ...
                    return (react.createElement("div", { key: option.optionId, className: `flex items-center space-x-2 cursor-pointer py-2` },
                        react.createElement(Checkbox, { checked: isSelected, id: `${attribute.attributeCode}-${option.optionId}`, onCheckedChange: (checked) => handleAttributeChange(attribute.attributeCode, option.optionId.toString(), checked) }),
                        react.createElement(Label, { htmlFor: `${attribute.attributeCode}-${option.optionId}` }, option.optionText)));
                })) : (react.createElement("div", { className: "text-muted-foreground text-sm text-center py-4" }, _('No options found for "${code}"', {
                    code: searchTerms[attribute.attributeCode]
                })))),
                !searchTerms[attribute.attributeCode] &&
                    attribute.options.length > 10 && (react.createElement(Button_Button, { variant: 'link', className: "text-primary text-sm mt-2 hover:underline" }, _('Show all ${count} options', {
...
const DefaultCategoryFilterRender = ({ categories, currentFilters }) => {
    ...
    return (react.createElement("div", { className: "category__filter__section border-b border-border pb-2 mb-2" },
        react.createElement("div", { className: "filter__header flex items-center justify-between mb-3" },
            react.createElement("button", { onClick: () => setIsCollapsed(!isCollapsed), className: "flex items-center justify-between text-left flex-1 hover:text-primary transition-colors" },
                react.createElement("span", { className: "font-medium" }, "Categories"),
                react.createElement("svg", { className: `w-4 h-4 transition-transform ${isCollapsed ? 'rotate-180' : ''}`, fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                    react.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M19 9l-7 7-7-7" }))),
            selectedCount > 0 && (react.createElement("button", { onClick: clearCategoryFilter, className: "text-muted-foreground hover:text-destructive text-sm transition-colors", title: "Clear categories" }, "\u2715"))),
        !isCollapsed && (react.createElement("div", { className: "filter__content" },
            react.createElement("div", { className: "category__options space-y-2 max-h-48 overflow-y-auto" }, filteredCategories.length > 0 ? (filteredCategories.map((category) => {
                ...
                return (react.createElement("div", { key: category.categoryId, className: `flex items-center space-x-3 cursor-pointer py-2` },
                    react.createElement(Checkbox, { id: `category-${category.categoryId}`, checked: isSelected, onCheckedChange: (checked) => handleCategoryChange(category.categoryId.toString(), checked) }),
                    react.createElement(Label, { htmlFor: `category-${category.categoryId}` }, category.name)));
...
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/slider/root/SliderRoot.js
var SliderRoot = __webpack_require__(17362);
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/slider/control/SliderControl.js
var SliderControl = __webpack_require__(43970);
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/slider/track/SliderTrack.js
var SliderTrack = __webpack_require__(38586);
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/slider/indicator/SliderIndicator.js
var SliderIndicator = __webpack_require__(47730);
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/slider/thumb/SliderThumb.js
var SliderThumb = __webpack_require__(55522);
;// ./node_modules/@evershop/evershop/dist/components/common/ui/Slider.js
...
function Slider({ className, defaultValue, value, min = 0, max = 100, ...props }) {
    ...
    return (react.createElement(SliderRoot/* SliderRoot */.g, { className: "data-horizontal:w-full data-vertical:h-full", "data-slot": "slider", defaultValue: defaultValue, value: value, min: min, max: max, thumbAlignment: "edge", ...props },
        react.createElement(SliderControl/* SliderControl */.X, { className: cn('data-vertical:min-h-40 relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:w-auto data-vertical:flex-col', className) },
            react.createElement(SliderTrack/* SliderTrack */.h, { "data-slot": "slider-track", className: "bg-muted rounded-full data-horizontal:h-1.5 data-horizontal:w-full data-vertical:h-full data-vertical:w-1.5 relative overflow-hidden select-none" },
                react.createElement(SliderIndicator/* SliderIndicator */.X, { "data-slot": "slider-range", className: "bg-primary select-none data-horizontal:h-full data-vertical:w-full" })),
            Array.from({ length: _values.length }, (_, index) => (react.createElement(SliderThumb/* SliderThumb */.O, { "data-slot": "slider-thumb", key: index, className: "border-primary ring-ring/50 size-4 rounded-full border bg-white shadow-sm transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden block shrink-0 select-none disabled:pointer-events-none disabled:opacity-50" }))))));
}
    ...
    return (react.createElement(DefaultFilterWrapperRender, { title: _('Price') },
        react.createElement("div", { className: "price__filter border-b border-gray-200 pb-2 mb-2" },
            react.createElement("div", { className: "price__slider mb-4" },
                react.createElement(Slider, { min: priceRange.min, max: priceRange.max, value: [localMin, localMax], onValueChange: handleRangeChange })),
...
function ItemActions({ className, ...props }) {
    return (Item_React.createElement("div", { "data-slot": "item-actions", className: Item_cn('gap-2 flex items-center', className), ...props }));
}
...
const DefaultProductFilterSummary = ({ availableAttributes, currentFilters, priceRange, categories }) => {
    ...
    return (react.createElement(Item, { variant: 'outline', className: "mb-3" },
        react.createElement(ItemContent, null,
            react.createElement(ItemTitle, null, _('Active Filters')),
            react.createElement(ItemDescription, null,
                react.createElement("div", { className: "space-y-2" }, filterSummary.map((summary, index) => (react.createElement("div", { key: index, className: "text-sm" }, summary))))))));
};
...
const DefaultProductFilterRender = ({ renderProps, className = '', title = _('Filter Products'), showFilterSummary = true }) => {
    ...
    return (react.createElement(ProductFilterDispatch.Provider, { value: contextValue },
        ...
        react.createElement(Sheet, { open: isMobileFilterOpen, onOpenChange: setIsMobileFilterOpen },
            react.createElement(SheetContent, { side: "bottom", className: "md:hidden max-h-[85vh] border-border" },
                react.createElement(SheetHeader, null,
                    react.createElement(SheetTitle, null, _('Filters'))),
                ...
                react.createElement(SheetFooter, { className: "grid grid-cols-2 gap-3" },
                    react.createElement(Button_Button, { variant: "outline", onClick: clearAllFilters, disabled: isLoading || activeFilterCount === 0, className: "flex-1" }, _('Clear All')),
                    react.createElement(Button_Button, { variant: "default", onClick: () => setIsMobileFilterOpen(false) }, _('Apply Filters'))))),
        react.createElement("div", { className: `hidden md:block product__filters ${className}` },
            react.createElement("div", { className: "product__filters__header flex items-center justify-between mb-4" },
                title && (react.createElement("h3", { className: "font-bold text-lg flex items-center" }, title)),
                activeFilterCount > 0 && (react.createElement("button", { onClick: clearAllFilters, disabled: isLoading, className: "text-sm hover:text-destructive transition-colors disabled:opacity-50" }, _('Clear All')))),
            showFilterSummary && (react.createElement(DefaultProductFilterSummary, { availableAttributes: availableAttributes, currentFilters: currentFilters, priceRange: priceRange, categories: categories })),
            react.createElement("div", { className: isLoading ? 'opacity-75 pointer-events-none' : '' },
                react.createElement(common_Area, { id: "productFilter", noOuter: true, coreComponents: defaultComponents, availableAttributes: availableAttributes, priceRange: priceRange, currentFilters: currentFilters, categories: categories, setting: setting })))));
};
...
function CategoryProductsFilter() {
    ...
    return (react.createElement(react.Fragment, null,
        ...
        react.createElement(ProductFilter, { currentFilters: category.products.currentFilters, availableAttributes: category.availableAttributes, categories: category.children, priceRange: category.priceRange }, (renderProps) => (react.createElement(DefaultProductFilterRender, { renderProps: renderProps, title: _('Product Filters'), showFilterSummary: true }))),
...
;// ./node_modules/@evershop/evershop/dist/components/common/ui/Pagination.js
...
function PaginationContent({ className, ...props }) {
    return (react.createElement("ul", { "data-slot": "pagination-content", className: cn('gap-1 flex items-center', className), ...props }));
}
function PaginationItem({ ...props }) {
    return react.createElement("li", { "data-slot": "pagination-item", ...props });
}
function PaginationLink({ className, isActive, size = 'icon', ...props }) {
    return (react.createElement(Button_Button, { variant: isActive ? 'outline' : 'ghost', size: size, className: cn(className), nativeButton: false, render: react.createElement("a", { "aria-current": isActive ? 'page' : undefined, "data-slot": "pagination-link", "data-active": isActive, ...props }) }));
}
function PaginationPrevious({ className, ...props }) {
    return (react.createElement(PaginationLink, { "aria-label": "Go to previous page", size: "default", className: cn('pl-2!', className), ...props },
        react.createElement(chevron_left/* default */.A, { "data-icon": "inline-start" }),
        react.createElement("span", { className: "hidden sm:block" }, "Previous")));
}
function PaginationNext({ className, ...props }) {
    return (react.createElement(PaginationLink, { "aria-label": "Go to next page", size: "default", className: cn('pr-2!', className), ...props },
        react.createElement("span", { className: "hidden sm:block" }, "Next"),
        react.createElement(chevron_right/* default */.A, { "data-icon": "inline-end" })));
}
function PaginationEllipsis({ className, ...props }) {
    return (react.createElement("span", { "aria-hidden": true, "data-slot": "pagination-ellipsis", className: cn("size-9 items-center justify-center [&_svg:not([class*='size-'])]:size-4 flex items-center justify-center", className), ...props },
        react.createElement(ellipsis/* default */.A, null),
...
/* unused harmony import specifier */ var Pagination_React;



const PaginationContext = react.createContext(null);
const usePagination = () => {
    const context = Pagination_React.useContext(PaginationContext);
    if (!context) {
...
function Pagination_Pagination({ total, limit, currentPage, children, onPageChange, scrollToTop = true, scrollBehavior = 'smooth' }) {
...
const DefaultPaginationRenderer = ({ renderProps, className = '', showInfo = false }) => {
    ...
    return (react.createElement("div", { className: `products-pagination ${className}` },
        showInfo && (react.createElement("div", { className: "pagination-info text-center text-muted-foreground mb-4" }, getDisplayText())),
        react.createElement(Pagination, null,
            react.createElement(PaginationContent, null,
                hasPrev && (react.createElement(PaginationItem, null,
                    react.createElement(PaginationPrevious, { href: "#", onClick: (e) => {
                            e.preventDefault();
                            if (!isLoading)
                                goToPrev();
                        }, "aria-disabled": isLoading, className: isLoading ? 'pointer-events-none opacity-50' : '' }))),
                showStartEllipsis && (react.createElement(react.Fragment, null,
                    react.createElement(PaginationItem, null,
                        react.createElement(PaginationLink, { href: "#", onClick: (e) => {
                                e.preventDefault();
                                if (!isLoading)
                                    goToPage(1);
                            }, "aria-disabled": isLoading, className: isLoading ? 'pointer-events-none opacity-50' : '' }, "1")),
                    react.createElement(PaginationItem, null,
                        react.createElement(PaginationEllipsis, null)))),
                pageNumbers.map((p) => (react.createElement(PaginationItem, { key: p },
                    react.createElement(PaginationLink, { href: "#", onClick: (e) => {
                            e.preventDefault();
                            if (!isLoading && !isCurrentPage(p))
                                goToPage(p);
                        }, isActive: isCurrentPage(p), "aria-disabled": isLoading || isCurrentPage(p), className: isLoading || isCurrentPage(p)
                            ? 'pointer-events-none opacity-50'
                            : '' }, p)))),
                showEndEllipsis && (react.createElement(react.Fragment, null,
                    react.createElement(PaginationItem, null,
                        react.createElement(PaginationEllipsis, null)),
                    react.createElement(PaginationItem, null,
                        react.createElement(PaginationLink, { href: "#", onClick: (e) => {
                                ...
                                if (!isLoading)
                                    goToPage(totalPages);
                            }, "aria-disabled": isLoading, className: isLoading ? 'pointer-events-none opacity-50' : '' }, totalPages)))),
                hasNext && (react.createElement(PaginationItem, null,
                    react.createElement(PaginationNext, { href: "#", onClick: (e) => {
                            e.preventDefault();
                            if (!isLoading)
                                goToNext();
                        }, "aria-disabled": isLoading, className: isLoading ? 'pointer-events-none opacity-50' : '' }))))),
        isLoading && (react.createElement("div", { className: "pagination-loading text-center mt-2" },
            react.createElement("div", { className: "inline-block w-4 h-4 border-2 border-primary border-t-transparent rounded-full animate-spin" })))));
};
...
const CompactPaginationRenderer = ({ renderProps, className = '' }) => {
    ...
    return (Pagination_React.createElement("div", { className: `compact-pagination flex items-center justify-between ${className}` },
        Pagination_React.createElement("div", { className: "pagination-info text-sm text-gray-600" },
            "Showing ",
            showing,
            " of ",
            total),
        Pagination_React.createElement("div", { className: "pagination-controls flex items-center space-x-2" },
            Pagination_React.createElement("button", { onClick: goToPrev, disabled: !hasPrev || isLoading, className: "px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" }, "Previous"),
            Pagination_React.createElement("span", { className: "text-sm text-gray-600" },
                "Page ",
                currentPage,
                " of ",
                totalPages),
            Pagination_React.createElement("button", { onClick: goToNext, disabled: !hasNext || isLoading, className: "px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" }, "Next"))));
};
const InputPaginationRenderer = ({ renderProps, className = '' }) => {
    ...
    const [inputPage, setInputPage] = Pagination_React.useState(currentPage.toString());
    Pagination_React.useEffect(() => {
    ...
    return (Pagination_React.createElement("div", { className: `input-pagination ${className}` },
        Pagination_React.createElement("div", { className: "text-center text-sm text-gray-600 mb-4" }, getDisplayText()),
        Pagination_React.createElement("div", { className: "flex items-center justify-center space-x-4" },
            Pagination_React.createElement("button", { onClick: goToFirst, disabled: !hasPrev || isLoading, className: "px-2 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50" }, "First"),
            Pagination_React.createElement("button", { onClick: goToPrev, disabled: !hasPrev || isLoading, className: "px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50" }, "\u2190"),
            Pagination_React.createElement("form", { onSubmit: handleInputSubmit, className: "flex items-center space-x-2" },
                Pagination_React.createElement("span", { className: "text-sm" }, "Page"),
                Pagination_React.createElement("input", { type: "number", min: "1", max: totalPages, value: inputPage, onChange: (e) => setInputPage(e.target.value), className: "w-16 px-2 py-1 text-sm border border-gray-300 rounded text-center", disabled: isLoading }),
                Pagination_React.createElement("span", { className: "text-sm" },
                    "of ",
                    totalPages),
                Pagination_React.createElement("button", { type: "submit", className: "px-2 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50", disabled: isLoading }, "Go")),
            Pagination_React.createElement("button", { onClick: goToNext, disabled: !hasNext || isLoading, className: "px-3 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50" }, "\u2192"),
            Pagination_React.createElement("button", { onClick: goToLast, disabled: !hasNext || isLoading, className: "px-2 py-1 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50" }, "Last"))));
};
//# sourceMappingURL=Pagination.js.map
...
function CategoryProductsPagination() {
    ...
    return (react.createElement(Pagination_Pagination, { total: products.total, limit: limit ? parseInt(limit.value, 10) : 20, currentPage: parseInt((page === null || page === void 0 ? void 0 : page.value) || '1', 10) }, (paginationProps) => (react.createElement(DefaultPaginationRenderer, { renderProps: paginationProps }))));
}
...
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/select/group/SelectGroup.js
var SelectGroup = __webpack_require__(12112);
...
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/select/group-label/SelectGroupLabel.js
var SelectGroupLabel = __webpack_require__(24161);
...
function Select_SelectGroup({ className, ...props }) {
    return (react.createElement(SelectGroup/* SelectGroup */.s, { "data-slot": "select-group", className: cn('scroll-my-1 p-1', className), ...props }));
}
...
function SelectLabel({ className, ...props }) {
    return (react.createElement(SelectGroupLabel/* SelectGroupLabel */.M, { "data-slot": "select-label", className: cn('text-muted-foreground px-2 py-1.5 text-xs', className), ...props }));
}
...
var arrow_down_wide_narrow = __webpack_require__(95545);
...
function ProductSorting({ sortOptions = defaultSortOptions, defaultSortBy = '', defaultSortOrder = 'asc', showSortDirection = true, enableUrlUpdate = true, onSortChange, renderSortSelect, renderSortDirection, className = '', disabled = false }) {
    ...
    const defaultSortSelect = (props) => (react.createElement(Select, { value: props.options.find((option) => option.code === props.value), onValueChange: (value) => props.onChange((value === null || value === void 0 ? void 0 : value.code) || ''), disabled: props.disabled },
        react.createElement(Select_SelectTrigger, { className: "w-full" },
            react.createElement(Select_SelectValue, { placeholder: _('Select sort') })),
        react.createElement(SelectContent, null,
            react.createElement(Select_SelectGroup, null,
                react.createElement(SelectLabel, null, _('Sort By')),
                props.options.map((option) => (react.createElement(Select_SelectItem, { key: option.code, value: option, disabled: option.disabled }, option.label || option.name)))))));
    const defaultSortDirection = (props) => (react.createElement("button", { type: "button", onClick: props.onToggle, disabled: props.disabled, className: `sort-direction-btn flex items-center justify-center ${props.disabled
            ? 'opacity-50 cursor-not-allowed'
            : 'hover:text-primary cursor-pointer'}`, "aria-label": `Sort ${props.sortOrder === 'asc' ? 'descending' : 'ascending'}` }, props.sortOrder === 'desc' ? (react.createElement(arrow_down_wide_narrow/* default */.A, { className: "w-5 h-5 text-muted-foreground" })) : (react.createElement(arrow_up_wide_narrow/* default */.A, { className: "w-5 h-5 text-muted-foreground" }))));
    const containerContent = (react.createElement(react.Fragment, null,
        react.createElement("div", { className: "sort-select grow" }, renderSortSelect
            ? renderSortSelect({
                options: sortOptions,
                value: sortBy,
    ...
    return (react.createElement("div", { className: cn(`product-sorting flex gap-2 items-center`, className) }, containerContent));
}
    ...
    return (react.createElement(CategoryProvider, { category: category },
        ...
        react.createElement("div", { className: "page-width grid grid-cols-1 md:grid-cols-4 gap-5" },
            ...
            react.createElement(common_Area, { id: "categoryRightColumn", className: "md:col-span-3", coreComponents: [
                    {
                        component: {
                            default: (react.createElement("div", { className: "flex justify-between items-center border-b border-border pb-2 mb-8" },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(75271)))
