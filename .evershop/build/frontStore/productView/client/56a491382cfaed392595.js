...
const DefaultVariantOptionItem = ({ option, attribute, isSelected, onSelect }) => {
    ...
    return (react.createElement("li", { key: option.optionId, className: className },
        react.createElement(Button_Button, { variant: isSelected ? 'default' : 'outline', onClick: async (e) => {
                e.preventDefault();
                if (option.available === false) {
                    return;
                }
                await onSelect(attribute.attributeCode, option.optionId);
            }, className: 'group-[.selected]:border-primary' }, option.optionText)));
};
...
function VariantSelector({ AttributeRenderer = DefaultVariantAttribute, OptionRenderer = DefaultVariantOptionItem }) {
    ...
    return (react.createElement("div", { className: "variant variant__container grid grid-cols-1 gap-2 mt-5" },
        ...
        errors.variant_selected && (react.createElement("div", { className: "text-destructive" }, _('Please select variant options')))));
}
                ...
                },
                {
                    component: {
                        default: (react.createElement(AddToCart, { product: {
                                sku: sku,
                                isInStock: isInStock
                            }, qty: form.watch('qty') || 1, onSuccess: () => {
                            ...
                            state.isInStock === true && (react.createElement(react.Fragment, null,
                                ...
                                react.createElement(Button_Button, { variant: 'default', size: 'lg', onClick: () => {
                                    ...
                                    }, className: "w-full py-6", isLoading: addingToCart || state.isLoading }, _('ADD TO CART')))),
                            state.isInStock === false && (react.createElement(Button_Button, { onClick: () => { }, className: "w-full py-6", disabled: true }, _('SOLD OUT')))))))
                    },
                    sortOrder: 30,
                    id: 'addToCartButton'
                }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(95630)))
