...
const SubmitButton = ({ formId }) => {
    ...
    return (react.createElement("div", { className: "form-submit-button flex border-t border-border mt-4 pt-4 justify-between" },
        react.createElement(Button_Button, { className: 'w-full', size: 'lg', onClick: () => {
            ...
            }, isLoading: isSubmitting }, _(isSubmitting ? 'Signing In...' : 'Sign In'))));
};
const CustomerLoginForm = ({ title, subtitle, redirectUrl, onError, className }) => {
    const { login } = useCustomerDispatch();
    return (react.createElement("div", { className: cn(`login__form`, className) },
        react.createElement("div", { className: "login__form__inner w-full" },
            ...
            react.createElement(Form, { id: "loginForm", method: "POST", onSubmit: async (data) => {
                ...
                react.createElement(common_Area, { id: "customerLoginForm", className: "space-y-3", coreComponents: [
                        {
                            component: {
                                default: (react.createElement(InputField, { prefixIcon: react.createElement(mail/* default */.A, { className: "h-5 w-5" }), label: _('Email'), name: "email", placeholder: _('Email'), required: true, validation: {
                        ...
                        {
                            component: {
                                default: (react.createElement(PasswordField, { prefixIcon: react.createElement(lock_keyhole/* default */.A, { className: "h-5 w-5" }), label: _('Password'), name: "password", placeholder: _('Password'), required: true, validation: {
...
function LoginPage({ homeUrl, registerUrl, forgotPasswordUrl }) {
    return (react.createElement("div", { className: "login__page flex flex-col justify-center items-center" },
        ...
        react.createElement("div", { className: "login__page__options text-center mt-2 gap-5 flex justify-center" },
            ...
            react.createElement("a", { className: "text-destructive hover:underline", href: forgotPasswordUrl }, _('Forgot your password?')))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(71496)))
