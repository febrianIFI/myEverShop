...
// EXTERNAL MODULE: ./node_modules/lucide-react/dist/esm/icons/lock-keyhole.js
var lock_keyhole = __webpack_require__(67378);
...
const SubmitButton = ({ formId }) => {
    ...
    return (react.createElement("div", { className: "form-submit-button flex border-t border-border mt-4 pt-4 justify-between" },
        react.createElement(Button_Button, { className: 'w-full', size: 'lg', onClick: () => {
                document.getElementById(formId).dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
            }, isLoading: isSubmitting }, _(isSubmitting ? 'Signing Up...' : 'Sign Up'))));
};
    ...
    return (react.createElement("div", { className: `register__form ${className}` },
        react.createElement("div", { className: "register__form__inner w-full" },
            ...
            react.createElement(Form, { id: "registerForm", method: "POST", onSubmit: async (data) => {
                ...
                react.createElement(common_Area, { id: "customerRegisterForm", className: "space-y-3", coreComponents: [
                        {
                            component: {
                                default: (react.createElement(InputField, { prefixIcon: react.createElement(user/* default */.A, { className: "h-5 w-5" }), name: "full_name", label: _('Full Name'), placeholder: _('Full Name'), required: true, validation: { required: _('Full Name is required') } }))
                            },
                            sortOrder: 10
                        },
                        {
                            component: {
                                default: (react.createElement(EmailField, { prefixIcon: react.createElement(mail/* default */.A, { className: "h-5 w-5" }), name: "email", label: _('Email'), placeholder: _('Email'), required: true, validation: { required: _('Email is required') } }))
                            },
                            sortOrder: 20
                        },
                        {
                            component: {
                                default: (react.createElement(PasswordField, { prefixIcon: react.createElement(lock_keyhole/* default */.A, { className: "h-5 w-5" }), name: "password", label: _('Password'), placeholder: _('Password'), required: true, showToggle: true, validation: { required: _('Password is required') } }))
                            },
                            sortOrder: 30
                        },
                        {
                            component: {
                                default: react.createElement(SubmitButton, { formId: "registerForm" })
                            },
                            sortOrder: 30
                        }
                    ] })),
...
function RegisterPage({ homeUrl, loginUrl }) {
    return (react.createElement("div", { className: "flex justify-center items-center flex-col gap-3" },
        react.createElement(Card, { className: "flex justify-center items-center max-w-max md:max-w-[80%]" },
        ...
        react.createElement("div", { className: "text-center" },
            react.createElement("span", null,
                ...
                react.createElement("a", { className: "text-primary hover:underline", href: loginUrl },
                    ' ',
                    _('Login'),
                    ' ')))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(82913)))
