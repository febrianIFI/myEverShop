...
function GroupRow({ groups }) {
    ...
    return (react.createElement(TableCell, null, groups.map((group) => (react.createElement("div", { key: group.attributeGroupId },
        react.createElement(Badge, { variant: 'secondary' },
            react.createElement("a", { href: "#", className: "hover:underline", onClick: (e) => {
                    e.preventDefault();
                    onEdit(group);
                } }, group.groupName)))))));
}
...
function AttributeGrid({ attributes: { items: attributes, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "attributeGridFilter" },
        ...
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    attributes.map((a) => (react.createElement(TableRow, { key: a.attributeId },
                        react.createElement(TableCell, null,
                            react.createElement("div", { className: "form-field mb-0" },
                                react.createElement(Checkbox, { checked: selectedRows.includes(a.uuid), onCheckedChange: (checked) => {
                                        if (checked) {
                        ...
                        react.createElement(common_Area, { className: "", id: "attributeGridRow", row: a, noOuter: true, coreComponents: [
                                ...
                                {
                                    component: {
                                        default: ({ areaProps }) => (react.createElement(TableCell, null,
                                            react.createElement(Badge, { variant: "outline" }, areaProps.row.type)))
                                    },
                                    sortOrder: 20
                                },
                                {
                                    component: {
                                        default: () => (react.createElement(TableCell, null, a.isRequired ? 'Yes' : 'No'))
                                    },
                                    sortOrder: 25
                                },
                                {
                                    component: {
                                        default: () => (react.createElement(TableCell, null, a.isFilterable ? 'Yes' : 'No'))
                                    },
                                    sortOrder: 30
                                }
                            ] })))))),
            attributes.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no attribute to display")),
...
function NewAttributeButton({ newAttributeUrl }) {
    return (react.createElement(Button_Button, { onClick: () => (window.location.href = newAttributeUrl) }, "New Attribute"));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(97024)))
