...
function TableCell({ className, ...props }) {
    return (Table_React.createElement("td", { "data-slot": "table-cell", className: Table_cn('p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0', className), ...props }));
}
...
function RateForm({ saveRateApi, closeModal, getTaxClasses, rate }) {
    ...
    return (react.createElement(Form, { form: form, id: "taxRateForm", method: rate ? 'PATCH' : 'POST', action: saveRateApi, submitBtn: false, onError: (error) => {
        ...
        react.createElement("div", { className: "py-3 border-t border-border" },
        ...
        react.createElement("div", { className: "py-3 border-t border-border" },
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", null,
                    react.createElement(InputField, { name: "country", label: "Country", placeholder: "Country", required: true, validation: { required: 'Country is required' }, defaultValue: rate === null || rate === void 0 ? void 0 : rate.country, helperText: 'Country code (e.g., "US"). Use "*" for all countries.' })),
                react.createElement("div", null,
                    react.createElement(InputField, { name: "province", label: "Provinces", placeholder: "Provinces", required: true, validation: { required: 'Provinces is required' }, defaultValue: rate === null || rate === void 0 ? void 0 : rate.province, helperText: 'Province code (e.g., "CA"). Use "*" for all provinces.' })),
                react.createElement("div", null,
                    react.createElement(InputField, { name: "postcode", label: "Postcode", placeholder: "Postcode", required: true, validation: { required: 'Postcode is required' }, defaultValue: rate === null || rate === void 0 ? void 0 : rate.postcode, helperText: 'Postcode (e.g., "90210"). Empty for all postcodes.' }))),
        ...
        react.createElement("div", { className: "flex justify-end gap-2" },
            react.createElement(Button_Button, { title: "Cancel", variant: "secondary", onClick: closeModal }, "Cancel"),
...
function Rate({ rate, getTaxClasses }) {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
            react.createElement("td", { className: "border-none py-2 w-1/5" }, rate.name),
            react.createElement("td", { className: "border-none py-2" }, rate.country),
            ...
            react.createElement(DialogContent, null,
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, "Edit Tax Rate")),
                react.createElement(RateForm, { saveRateApi: rate.updateApi, closeModal: () => setDialogOpen(false), getTaxClasses: getTaxClasses, rate: rate })))));
}
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    react.createElement(TableHead, { className: "border-none" }, "Name"),
                    react.createElement(TableHead, { className: "border-none" }, "Country"),
                    react.createElement(TableHead, { className: "border-none" }, "Rate"),
                    react.createElement(TableHead, { className: "border-none" }, "Compound"),
                    react.createElement(TableHead, { className: "border-none" }, "Priority"),
                    react.createElement(TableHead, { className: "border-none" }, "Action"))),
            react.createElement(TableBody, null, rates.map((rate) => (react.createElement(TableRow, { key: rate.uuid, className: "border-divider py-5" },
        ...
        react.createElement("div", { className: "mt-2" },
            react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
                ...
                react.createElement(DialogContent, null,
                    react.createElement(DialogHeader, null,
                        react.createElement(Dialog_DialogTitle, null, "Add Tax Rate")),
                    react.createElement(RateForm, { saveRateApi: addRateApi, closeModal: () => setDialogOpen(false), getTaxClasses: getTaxClasses }))))));
}
...
function TaxClass({ taxClass, getTaxClasses }) {
    return (react.createElement(CardContent, { className: "py-3 border-t border-border" },
        react.createElement("div", { className: "text-xs uppercase font-semibold py-2" }, taxClass.name),
...
function TaxClassForm({ saveTaxClassApi, closeModal, getTaxClasses }) {
    return (react.createElement(Form, { id: "createTaxClass", method: "POST", action: saveTaxClassApi, submitBtn: false, onSuccess: async () => {
            await getTaxClasses({ requestPolicy: 'network-only' });
            closeModal();
        } },
            ...
            react.createElement("div", { className: "col-span-4 grid grid-cols-1 gap-5" },
                react.createElement(Card, null,
                    react.createElement(CardHeader, null,
                        react.createElement(CardTitle, null, "Tax calculation configuration"),
                        react.createElement(CardDescription, null, "Configure the tax classes that will be available to your customers at checkout.")),
                    react.createElement(CardContent, { title: "Basic configuration" },
                ...
                react.createElement(Card, { title: "Tax classes" },
                    react.createElement(CardHeader, null,
                        react.createElement(CardTitle, null, "Tax classes"),
                        react.createElement(CardDescription, null, "Manage tax classes and tax rates for different regions.")),
                    react.createElement(TaxClasses, { classes: taxClassesQueryData.data.taxClasses.items, getTaxClasses: reexecuteQuery }),
                    react.createElement(CardContent, null,
                        react.createElement("div", null,
                            react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
                                react.createElement(Dialog_DialogTrigger, null,
                                    react.createElement(Button_Button, { title: "Create new tax class", variant: "outline", onClick: () => setDialogOpen(true) }, "Create new tax class")),
                                react.createElement(DialogContent, null,
                                    react.createElement(DialogHeader, null,
                                        react.createElement(Dialog_DialogTitle, null, "Create New Tax Class")),
                                    react.createElement(TaxClassForm, { saveTaxClassApi: createTaxClassApi, closeModal: () => setDialogOpen(false), getTaxClasses: reexecuteQuery }))))))))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(78627)))
