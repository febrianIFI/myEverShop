...
function PaymentStatus({ status }) {
    return (react.createElement(TableCell, null,
        react.createElement(Badge, { variant: status.badge || 'default' }, status.name)));
}
    ...
    const actions = [
        {
            ...
            onAction: () => {
                openAlert({
                    ...
                    content: (react.createElement("div", { className: "form-field mb-0" }, "Are you sure you want to mark the selected orders as shipped?")),
                    primaryAction: {
                        title: 'Cancel',
                        onAction: closeAlert,
                        variant: 'secondary'
...
function OrderGrid({ orders: { items: orders, total, currentFilters = [] }, paymentStatusList, shipmentStatusList }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "orderGridFilter" },
                            ...
                            },
                            {
                                component: {
                                    default: () => (react.createElement(react.Fragment, null,
                                        react.createElement(Select, { value: currentFilters.find((f) => f.key === 'payment_status')
                                            ...
                                            react.createElement(Select_SelectTrigger, null,
                                                react.createElement(Select_SelectValue, null, "Payment Status")),
                                            react.createElement(SelectContent, null,
                                                react.createElement(Select_SelectGroup, null,
                                                    react.createElement(SelectLabel, null, "Payment Status"),
                                                    paymentStatusList.map((status, index) => (react.createElement(Select_SelectItem, { key: index, value: status.code }, status.name))))))))
                                },
                                sortOrder: 10
                            },
                            {
                                component: {
                                    default: () => (react.createElement(Select, { value: currentFilters.find((f) => f.key === 'shipment_status')
                                        ...
                                        react.createElement(Select_SelectTrigger, null,
                                            react.createElement(Select_SelectValue, null, "Shipment Status")),
                                        react.createElement(SelectContent, null,
                                            react.createElement(Select_SelectGroup, null,
                                                react.createElement(SelectLabel, null, "Shipment Status"),
                                                shipmentStatusList.map((status, index) => (react.createElement(Select_SelectItem, { key: index, value: status.code }, status.name)))))))
                                },
                                sortOrder: 15
                            }
        ...
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    orders.map((o) => (react.createElement(TableRow, { key: o.orderId },
                        react.createElement(TableCell, null,
                            react.createElement("div", { className: "form-field mb-0" },
                                react.createElement(Checkbox, { checked: selectedRows.includes(o.uuid), onCheckedChange: (checked) => {
                                        if (checked) {
                        ...
                        react.createElement(common_Area, { className: "", id: "orderGridRow", row: o, noOuter: true, coreComponents: [
                                ...
                                {
                                    component: {
                                        default: () => react.createElement(TableCell, null, o.createdAt.text)
                                    },
                                    sortOrder: 10
                                },
                                {
                                    component: {
                                        default: ({ areaProps }) => (react.createElement(TableCell, null, o.customerEmail))
                                    },
                                    sortOrder: 15
                                },
                                {
                                ...
                                {
                                    component: {
                                        default: () => (react.createElement(TableCell, null, o.grandTotal.text))
                                    },
                                    sortOrder: 30
                                }
                            ] })))))),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(70933)))
