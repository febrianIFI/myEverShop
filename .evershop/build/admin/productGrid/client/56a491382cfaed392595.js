...
;// ./node_modules/@evershop/evershop/dist/components/common/ui/ButtonGroup.js
/* unused harmony import specifier */ var mergeProps;
/* unused harmony import specifier */ var useRender;
/* unused harmony import specifier */ var ButtonGroup_Separator;
/* unused harmony import specifier */ var ButtonGroup_cn;
/* unused harmony import specifier */ var ButtonGroup_React;
...
const buttonGroupVariants = (0,dist/* cva */.F)("has-[>[data-slot=button-group]]:gap-2 has-[select[aria-hidden=true]:last-child]:[&>[data-slot=select-trigger]:last-of-type]:rounded-r-md flex w-fit items-stretch [&>*]:focus-visible:z-10 [&>*]:focus-visible:relative [&>[data-slot=select-trigger]:not([class*='w-'])]:w-fit [&>input]:flex-1", {
    variants: {
        orientation: {
...
function ButtonGroupText({ className, render, ...props }) {
    return useRender({
        defaultTagName: 'div',
        props: mergeProps({
            className: ButtonGroup_cn("bg-muted gap-2 rounded-md border px-2.5 text-sm font-medium shadow-xs [&_svg:not([class*='size-'])]:size-4 flex items-center [&_svg]:pointer-events-none", className)
        }, props),
        render,
        state: {
...
function ButtonGroupSeparator({ className, orientation = 'vertical', ...props }) {
    return (ButtonGroup_React.createElement(ButtonGroup_Separator, { "data-slot": "button-group-separator", orientation: orientation, className: ButtonGroup_cn('bg-input relative self-stretch data-[orientation=horizontal]:mx-px data-[orientation=horizontal]:w-auto data-[orientation=vertical]:my-px data-[orientation=vertical]:h-auto', className), ...props }));
}
...
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/GridPagination.js





function GridPagination({ total, limit, page }) {
    ...
    return (react.createElement("div", { className: "pagination flex w-full mt-3" },
        react.createElement("div", { className: "flex justify-between w-full space-x-2" },
            react.createElement(ButtonGroup, null,
                react.createElement(Button_Button, { variant: 'outline' }, "Show"),
                react.createElement(Select, { value: limit.toString(), onValueChange: (value) => {
                        const url = new URL(window.location.href);
                        url.searchParams.set('limit', (value === null || value === void 0 ? void 0 : value.toString()) || '10');
                        window.location.href = url.href;
                    } },
                    react.createElement(Select_SelectTrigger, { className: "w-20" },
                        react.createElement(Select_SelectValue, null, limit)),
                    react.createElement(SelectContent, null,
                        react.createElement(Select_SelectGroup, null,
                            react.createElement(SelectLabel, null, "Limit"),
                            react.createElement(Select_SelectItem, { value: "50" }, "50"),
                            react.createElement(Select_SelectItem, { value: "100" }, "100"),
                            react.createElement(Select_SelectItem, { value: "150" }, "150"),
                            react.createElement(Select_SelectItem, { value: "200" }, "200"))))),
            react.createElement("div", { className: "flex justify-end" },
                react.createElement(Pagination, null,
                    react.createElement(PaginationContent, null,
                        react.createElement(PaginationItem, null,
                            react.createElement(PaginationPrevious, { onClick: (e) => {
                                    onPrev(e);
                                } })),
                        page > 1 && (react.createElement(PaginationItem, null,
                            react.createElement(PaginationLink, { isActive: page === 1, onClick: (e) => {
                                    onFirst(e);
                                } }, "1"))),
                        page >= 3 && (react.createElement(PaginationItem, null,
                            react.createElement(PaginationEllipsis, null))),
                        react.createElement(PaginationItem, null,
                            react.createElement(PaginationLink, { isActive: true }, page)),
                        page < Math.ceil(total / limit) - 1 && (react.createElement(PaginationItem, null,
                            react.createElement(PaginationEllipsis, null))),
                        page * limit < total && (react.createElement(PaginationItem, null,
                            react.createElement(PaginationLink, { isActive: page === Math.ceil(total / limit), onClick: (e) => {
                                    onLast(e);
                                } }, Math.ceil(total / limit)))),
                        react.createElement(PaginationNext, { onClick: onNext })))))));
}
...
function SortableHeader({ title, name, currentFilters = [] }) {
    ...
    return (react.createElement(TableCell, null,
        react.createElement("div", { className: "table-header flex justify-start gap-2 content-center" },
            react.createElement("div", { className: "font-medium uppercase text-xs" },
                react.createElement("span", null, title)),
            react.createElement("div", { className: "sort flex items-center" },
...
var merge_props_mergeProps = __webpack_require__(10866);
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/use-render/useRender.js
var use_render_useRender = __webpack_require__(92834);
...
function Badge({ className, variant = 'default', render, ...props }) {
    return (0,use_render_useRender/* useRender */.C)({
        defaultTagName: 'span',
        props: (0,merge_props_mergeProps/* mergeProps */.v6)({
...
function Status({ status }) {
    return (react.createElement(TableCell, null,
        react.createElement("div", null,
            status === 0 && react.createElement(Badge, { variant: "destructive" }, "Inactive"),
            status === 1 && react.createElement(Badge, { variant: "success" }, "Active"))));
}
...
function ProductNameRow({ url, name }) {
    return (react.createElement(TableCell, null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url, title: name }, name.length > 50 ? `${name.substring(0, 50)}...` : name))));
}
...
function Actions({ products = [], selectedIds = [] }) {
    ...
    return (react.createElement(TableRow, null,
        ...
        selectedIds.length > 0 && (react.createElement(TableCell, { style: { borderTop: 0 }, colSpan: "100" },
            react.createElement(ButtonGroup, null, actions.map((action, i) => (react.createElement(Button_Button, { key: i, variant: 'outline', onClick: (e) => {
                    e.preventDefault();
                    action.onAction();
                } }, action.name))))))));
}
...
function ProductGrid({ products: { items: products, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "productGridFilter" },
                    ...
                    react.createElement(common_Area, { id: "productGridFilter", noOuter: true, coreComponents: [
                            ...
                            },
                            {
                                component: {
                                    default: () => {
                                        var _a;
                                        return (react.createElement(Select, { value: (_a = currentFilters.find((f) => f.key === 'status')) === null || _a === void 0 ? void 0 : _a.value, onValueChange: (value) => {
                                                const url = new URL(document.location);
                                                url.searchParams.set('status', value);
                                                window.location.href = url.href;
                                            } },
                                            react.createElement(Select_SelectTrigger, null,
                                                react.createElement(Select_SelectValue, null, "Status")),
                                            react.createElement(SelectContent, null,
                                                react.createElement(Select_SelectGroup, null,
                                                    react.createElement(SelectLabel, null, "Status"),
                                                    react.createElement(Select_SelectItem, { value: "1" }, "Enabled"),
                                                    react.createElement(Select_SelectItem, { value: "0" }, "Disabled")))));
                                    }
                                },
                                sortOrder: 10
                            },
                            {
                                component: {
                                    default: () => {
                                        var _a;
                                        return (react.createElement(Select, { value: (_a = currentFilters.find((f) => f.key === 'type')) === null || _a === void 0 ? void 0 : _a.value, onValueChange: (value) => {
                                                const url = new URL(document.location);
                                                url.searchParams.set('type', value);
                                                window.location.href = url.href;
                                            } },
                                            react.createElement(Select_SelectTrigger, null,
                                                react.createElement(Select_SelectValue, null, "Product type")),
                                            react.createElement(SelectContent, null,
                                                react.createElement(Select_SelectGroup, null,
                                                    react.createElement(SelectLabel, null, "Product type"),
                                                    react.createElement(Select_SelectItem, { value: "simple" }, "Simple"),
                                                    react.createElement(Select_SelectItem, { value: "configurable" }, "Configurable")))));
                                    }
                                },
                                sortOrder: 15
                            }
            ...
            react.createElement(CardAction, null,
                react.createElement(Button_Button, { variant: "link", className: 'hover:cursor-pointer', onClick: () => {
                        const url = new URL(document.location);
                        url.search = '';
                        window.location.href = url.href;
                    } }, "Clear Filters"))),
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                react.createElement(TableHeader, null,
                    react.createElement(TableRow, null,
                        react.createElement(TableHead, null,
                            react.createElement(Checkbox, { onCheckedChange: (checked) => {
                                    if (checked) {
                        ...
                        react.createElement(common_Area, { id: "productGridHeader", noOuter: true, coreComponents: [
                                {
                                    component: {
                                        default: () => (react.createElement(TableHead, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    products.map((p) => (react.createElement(TableRow, { key: p.uuid },
                        react.createElement(TableCell, null,
                            react.createElement("div", { className: "form-field mb-0" },
                                react.createElement(Checkbox, { checked: selectedRows.includes(p.uuid), onCheckedChange: (checked) => {
                                        if (checked) {
                        ...
                        react.createElement(common_Area, { id: "productGridRow", row: p, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                                ...
                                },
                                {
                                    component: {
                                        default: () => {
                                            var _a;
                                            return (react.createElement(TableCell, null, (_a = p.price) === null || _a === void 0 ? void 0 : _a.regular.text));
                                        }
                                    },
                                    sortOrder: 15
                                },
                                {
                                    component: {
                                        default: () => react.createElement(TableCell, null, p.sku)
                                    },
                                    sortOrder: 20
                                },
                                {
                                    component: {
                                        default: () => { var _a; return react.createElement(TableCell, null, (_a = p.inventory) === null || _a === void 0 ? void 0 : _a.qty); }
                                    },
                                    sortOrder: 25
                                },
                                {
            ...
            products.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no product to display")),
            react.createElement(GridPagination, { total: total, limit: limit, page: page }))));
}
...
function NewProductButton({ newProductUrl }) {
    return (react.createElement(Button_Button, { onClick: () => (window.location.href = newProductUrl), title: "New Product" }, "New Product"));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(63120)))
