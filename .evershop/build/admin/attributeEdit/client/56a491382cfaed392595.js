...
function General({ attribute }) {
    return (react.createElement(Card, { className: "bg-popover" },
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Setting"),
            react.createElement(CardDescription, null, "Manage the setting of the attribute.")),
...
var circle_plus = __webpack_require__(590);
            ...
            react.createElement("div", { className: "grid gap-5 grid-cols-1" },
                react.createElement("div", null,
                    react.createElement("div", { className: "flex gap-5" },
                        react.createElement(InputGroup, { className: "max-w-xs" },
                            react.createElement(InputGroupInput, { type: "text", placeholder: "Create a new group", ref: newGroup }),
                            react.createElement(InputGroupAddon, { align: "inline-end" },
                                react.createElement("a", { className: "flex w-8 items-center justify-center text-primary", href: "#", onClick: (e) => {
                                        e.preventDefault();
                                        createGroup();
                                    } },
                                    react.createElement(circle_plus/* default */.A, { className: "size-4" }))))),
                    createGroupError && (react.createElement("p", { className: "text-destructive text-xs mt-1" }, createGroupError)))))));
};
        ...
        fields.map((field, index) => {
            return (react.createElement("div", { key: field.id, className: "flex items-center mb-2 space-x-5" },
                react.createElement("div", { className: "flex-1" },
                    react.createElement(InputField, { name: `options.${index}.option_text`, placeholder: "Option text", validation: { required: 'Option text is required' } }),
                    react.createElement(InputField, { type: "hidden", name: `options.${index}.option_id` })),
                react.createElement("div", { className: "self-center" },
                    react.createElement(Button_Button, { type: "button", onClick: (e) => {
                            e.preventDefault();
                            remove(index);
                        }, variant: 'destructive' }, "Remove"))));
        }),
        react.createElement("div", { className: "mt-2" },
            react.createElement(Button_Button, { type: "button", onClick: addOption, variant: 'outline' }, "Add option"))));
};
function General_General({ attribute, createGroupApi }) {
    const [type] = react.useState((attribute === null || attribute === void 0 ? void 0 : attribute.type) || 'text');
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "General"),
            react.createElement(CardDescription, null, "Manage the general information of the attribute.")),
        react.createElement(CardContent, null,
                ...
                react.createElement("div", null,
                    react.createElement("div", { className: "space-y-2" },
                        react.createElement(RadioGroupField, { name: "type", options: [
                            ...
                            ], label: "Type", defaultValue: attribute === null || attribute === void 0 ? void 0 : attribute.type, required: true, disabled: !!(attribute === null || attribute === void 0 ? void 0 : attribute.attributeId), validation: { required: 'Type is required' } }))))),
        ['select', 'multiselect'].includes(type) && (react.createElement(CardContent, { title: "Attribute options" },
            react.createElement(Options, { originOptions: get(attribute, 'options', []) }))),
        react.createElement(CardContent, { title: "Attribute Group" },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(64044)))
