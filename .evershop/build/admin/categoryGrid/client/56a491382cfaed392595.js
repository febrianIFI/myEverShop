...
function CategoryGrid({ categories: { items: categories, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "categoryGridFilter" },
        ...
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    categories.map((c) => (react.createElement(TableRow, { key: c.categoryId },
                        ...
                        react.createElement(common_Area, { className: "", id: "categoryGridRow", row: c, noOuter: true, coreComponents: [
                                ...
                                {
                                    component: {
                                        default: () => (react.createElement(TableCell, null, c.includeInNav ? 'Yes' : 'No'))
                                    },
                                    sortOrder: 30
                                }
                            ] })))))),
            categories.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no category to display")),
...
function NewCategoryButton({ newCateoryUrl }) {
    return (react.createElement(Button_Button, { onClick: () => (window.location.href = newCateoryUrl) }, "New Category"));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(54852)))
