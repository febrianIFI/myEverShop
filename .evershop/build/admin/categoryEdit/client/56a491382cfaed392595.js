    ...
    return (react.createElement(Dialog, null,
        react.createElement(Card, null,
            react.createElement(CardHeader, null,
                react.createElement(CardTitle, null, "Products"),
                react.createElement(CardDescription, null, "Manage the products assigned to this category."),
                react.createElement(CardAction, null,
                    react.createElement(Dialog_DialogTrigger, null,
                        react.createElement(Button_Button, { variant: "link" }, "Add Products")))),
            error && (react.createElement(CardContent, null,
                react.createElement("span", { className: "text-destructive" }, error.message))),
            react.createElement(CardContent, null,
                react.createElement("div", null,
                    react.createElement("div", { className: "mb-5" },
                        react.createElement("div", { className: "form-field" },
                            react.createElement(Input_Input, { type: "text", value: keyword, placeholder: "Search products", onChange: (e) => {
                                    setLoading(true);
                        ...
                        react.createElement("div", { className: "divide-y" }, data.category.products.items.map((p) => {
                            ...
                            return (react.createElement("div", { key: p.uuid, className: "flex justify-between py-2 border-divider items-center" },
                                ...
                                react.createElement("div", { className: "text-right" },
                                    react.createElement(Button_Button, { variant: "destructive", onClick: async () => {
                                            await removeProduct(p.removeFromCategoryUrl, p.uuid);
                                        }, isLoading: removing.includes(p.uuid) }, "Remove"))));
                        })))),
                    (fetching || loading) && react.createElement(ProductListSkeleton, null)))),
        react.createElement(DialogContent, { className: "sm:max-w-[90vw] lg:max-w-200" },
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Add Products"),
                react.createElement(Dialog_DialogDescription, null, "Add products to this category by selecting them from the list below."),
                data && (react.createElement(ProductSelector, { onSelect: addProductFunction, selectedProducts: data.category.products.items.map((p) => ({
                        sku: p.sku,
                        uuid: p.uuid,
...
var folder = __webpack_require__(94429);
...
`;
const CategoryTree_Skeleton = () => (react.createElement("ul", { className: "skeleton-wrapper-category-tree" },
...
function CategoryItem({ category, selectedCategories, onSelect }) {
    ...
    const { data, fetching, error } = result;
    if (error) {
        return (react.createElement("li", { className: "text-destructive" },
    ...
    return (react.createElement("li", { className: "[&_ul]:pl-2" },
        react.createElement("div", { className: className },
            category.hasChildren && (react.createElement("a", { href: "#", onClick: (e) => {
                ...
                } }, expanded ? (react.createElement(minus/* default */.A, { width: 15, height: 15 })) : (react.createElement(plus/* default */.A, { width: 15, height: 15 })))),
            !category.hasChildren && (react.createElement("span", null,
                react.createElement(minus/* default */.A, { width: 15, height: 15 }))),
            react.createElement("a", { href: "#", onClick: (e) => {
                    e.preventDefault();
                    onSelect(category);
                } },
                react.createElement("div", { className: "flex gap-2 justify-start items-center cursor-pointer" },
                    react.createElement(folder/* default */.A, { width: 20, height: 20 }),
        ...
        react.createElement(RenderIfTrue, { condition: fetching && expanded },
            react.createElement("div", { className: "pb-2" },
                react.createElement(CategoryTree_Skeleton, null)))));
}
...
function CategoryTree({ selectedCategories, onSelect }) {
    ...
    const { data, fetching, error } = result;
    if (fetching) {
        return react.createElement(CategoryTree_Skeleton, null);
    }
    if (error) {
...
const ParentCategory = ({ parent }) => {
    ...
    const handleCategoryChange = (newCategory) => {
        ...
        setValue('parent_id', (newCategory === null || newCategory === void 0 ? void 0 : newCategory.categoryId) || '');
    };
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
        react.createElement("div", { className: "my-3 space-y-3" },
            react.createElement(Label, null, "Parent category"),
            category && (react.createElement("div", { className: "border rounded border-border mb-2 p-2" },
                ...
                react.createElement("span", { className: "text-destructive pl-5 hover:underline" },
                    react.createElement("a", { href: "#", onClick: (e) => {
                            e.preventDefault();
            ...
            react.createElement(DialogContent, null,
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, "Select Parent Category")),
                react.createElement(CategoryTree, { selectedCategories: category ? [category] : [], onSelect: (c) => {
                        handleCategoryChange(c);
                        setDialogOpen(false);
                    } })),
            react.createElement(InputField, { type: "hidden", name: "parent_id", defaultValue: (category === null || category === void 0 ? void 0 : category.categoryId) || '' }))));
};
function General({ category }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            ...
            react.createElement(CardDescription, null, "Manage the general information of the category.")),
        react.createElement(CardContent, null,
...
function Image_Image({ category }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Category Image"),
            react.createElement(CardDescription, null, "Upload an image for the category.")),
        react.createElement(CardContent, null,
            ...
            react.createElement(InputField, { type: "hidden", value: image === null || image === void 0 ? void 0 : image.url, name: "image" }))));
}
const Image_layout = {
    areaId: 'rightSide',
    sortOrder: 10
...
function Seo({ category }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Search engine optimize"),
            react.createElement(CardDescription, null, "Manage the SEO settings of the category.")),
        react.createElement(CardContent, null,
            react.createElement(common_Area, { id: "categoryEditSeo", coreComponents: fields, className: "space-y-2" }))));
}
const Seo_layout = {
    areaId: 'leftSide',
    sortOrder: 60
...
function Status({ category }) {
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Status"),
        ...
        react.createElement(CardContent, { className: "pt-6 border-t border-border" },
            react.createElement(RadioGroupField, { name: "include_in_nav", label: "Include in Store Menu?", options: [
                    { label: 'No', value: 0 },
                    { label: 'Yes', value: 1 }
        ...
        react.createElement(CardContent, { className: "pt-6 border-t border-border" },
            react.createElement(RadioGroupField, { name: "show_products", label: "Show products?", options: [
                    { label: 'No', value: 0 },
                    { label: 'Yes', value: 1 }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(14827)))
