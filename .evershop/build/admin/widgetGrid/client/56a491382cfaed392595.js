...
function WidgetGrid({ widgets: { items, total, currentFilters = [] }, widgetTypes }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "widgetGridFilter" },
        ...
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    items.map((w, i) => (react.createElement(TableRow, { key: i },
                        react.createElement(TableCell, { style: { width: '2rem' } },
                            react.createElement("div", { className: "form-field mb-0" },
                                react.createElement(Checkbox, { checked: selectedRows.includes(w.uuid), onCheckedChange: (checked) => {
                                        if (checked) {
            ...
            items.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no widget to display")),
...
const WidgetTypes = ({ types }) => {
    return (react.createElement("div", { className: "space-y-2" }, types.map((type, index) => (react.createElement(Item, { key: index, variant: "outline" },
        react.createElement(ItemContent, null,
            react.createElement(ItemTitle, null,
                " ",
                type.name),
            react.createElement(ItemDescription, null, type.description)),
        react.createElement(ItemActions, null,
...
function NewWidgetButton({ widgetTypes }) {
    return (react.createElement(Dialog, null,
        react.createElement(Dialog_DialogTrigger, null,
            react.createElement(Button_Button, null, "New Widget")),
        react.createElement(DialogContent, null,
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "New Widget")),
            react.createElement(WidgetTypes, { types: widgetTypes }))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(5106)))
