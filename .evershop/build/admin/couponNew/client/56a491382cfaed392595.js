...
function CustomerCondition({ coupon, groups: { items: customerGroups } }) {
    ...
    return (react.createElement(common_Area, { id: "couponCustomerCondition", className: "space-y-3", coreComponents: [
            {
                component: {
            ...
            {
                component: {
                    default: (react.createElement(NumberField, { label: "Customer's purchase", placeholder: "Enter purchased amount", defaultValue: parseInt(condition === null || condition === void 0 ? void 0 : condition.purchased) || 0, name: "user_condition.purchased", min: 0, helperText: "Minimum purchased amount. This only applies to registered customers." }))
                },
                sortOrder: 30,
...
const ProductListSkeleton = () => {
    ...
    return (react.createElement("div", { className: "attribute-group-list-skeleton space-y-2 divide-y" }, skeletonItems.map((_, index) => (react.createElement("div", { key: index, className: "attribute-group-skeleton-item border-border pb-2 flex justify-between items-center " },
        react.createElement("div", { className: "flex items-center" },
            react.createElement(Skeleton, { className: "h-5 w-30 rounded" })),
        react.createElement("div", { className: "select-button" },
            react.createElement(Skeleton, { className: "h-6 w-12 rounded" })))))));
};
...
const ProductSelector = ({ onSelect, onUnSelect, selectedProducts }) => {
    ...
    return (react.createElement("div", null,
        react.createElement("div", { className: "p-2" },
            react.createElement(Input_Input, { type: "text", value: inputValue || '', placeholder: "Search products", onChange: (e) => {
            ...
            data.products.items.map((product) => {
                ...
                return (react.createElement("div", { key: product.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    ...
                    react.createElement("div", { className: "col-span-2 text-right" },
                        !isProductSelected(product, internalSelectedProducts) && (react.createElement(Button_Button, { variant: 'outline', onClick: async (e) => {
                                e.preventDefault();
                                await selectProduct(product.sku, product.uuid, product.productId);
                            } }, "Select")),
                        isProductSelected(product, internalSelectedProducts) && (react.createElement(Button_Button, { onClick: (e) => {
                                e.preventDefault();
                                unSelectProduct(product.sku, product.uuid, product.productId);
                            } },
                            react.createElement(check/* default */.A, { width: '1.2rem', height: '1.2rem' }))))));
            }))),
...
const SkuSelector = ({ product, updateProduct }) => {
    ...
    return (react.createElement(Dialog, null,
        react.createElement(Dialog_DialogTrigger, null,
            react.createElement(Button_Button, { variant: 'link' }, product.sku ? (react.createElement("span", { className: "italic" },
                "\u2018",
                product.sku,
                "\u2019")) : (react.createElement("span", null, "Choose SKU")))),
        react.createElement(DialogContent, { className: 'max-w-[80vw]' },
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Choose Product SKU")),
        ...
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    ...
                    react.createElement(TableHead, null, " "))),
            react.createElement(TableBody, null, fields.map((p, i) => (react.createElement(TableRow, { key: p.id },
                ...
                react.createElement(TableCell, null,
                    react.createElement("a", { className: "text-destructive", href: "#", onClick: (e) => {
                            e.preventDefault();
                            remove(i);
                        } },
    ...
    return (react.createElement("div", null,
        react.createElement("div", null,
            react.createElement("div", { className: "mb-5" },
                react.createElement(Input_Input, { type: "text", value: inputValue || '', placeholder: "Search attribute groups", onChange: (e) => {
                        setInputValue(e.target.value);
                        setLoading(true);
                    } })),
            ...
            !fetching && data && (react.createElement("div", { className: "divide-y" },
                ...
                data.attributeGroups.items.map((a) => (react.createElement("div", { key: a.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    ...
                    react.createElement("div", { className: "col-span-3 text-right" },
                        !isAttributeGroupSelected(a, internalSelectedAttributeGroups) && (react.createElement(Button_Button, { variant: "outline", onClick: async (e) => {
                                e.preventDefault();
                        ...
                        isAttributeGroupSelected(a, internalSelectedAttributeGroups) && (react.createElement(Button_Button, { onClick: (e) => {
                                e.preventDefault();
        ...
        react.createElement("div", { className: "flex justify-between gap-5 mt-3" },
...
const AttributeGroupConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: (open) => setDialogOpen(open), onOpenChangeComplete: (open) => {
            if (!open) {
                updateCondition(selectedIds.current);
            }
        } },
        react.createElement(Dialog_DialogTrigger, null,
            react.createElement(Button_Button, { variant: 'link' },
        ...
        react.createElement(DialogContent, { className: 'max-w-[60vw]' },
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Choose Attribute Groups")),
...
const CategoryConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: (open) => setDialogOpen(open), onOpenChangeComplete: (open) => {
        ...
        react.createElement(DialogContent, { className: 'max-w-[60vw]' },
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Choose Categories")),
...
const CollectionSelector = ({ onSelect, onUnSelect, selectedCollections }) => {
    ...
    return (react.createElement("div", null,
        react.createElement("div", null,
            react.createElement("div", { className: "p-2" },
                react.createElement(Input_Input, { type: "text", value: inputValue || '', placeholder: "Search collections", onChange: (e) => {
                        setInputValue(e.target.value);
                        setLoading(true);
                    } })),
            ...
            !fetching && data && (react.createElement("div", { className: "divide-y" },
                ...
                data.collections.items.map((c) => (react.createElement("div", { key: c.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    ...
                    react.createElement("div", { className: "col-span-3 text-right" },
                        !isCollectionSelected(c, internalSelectedCollections) && (react.createElement(Button_Button, { variant: "outline", onClick: async (e) => {
                                e.preventDefault();
                        ...
                        isCollectionSelected(c, internalSelectedCollections) && (react.createElement(Button_Button, { variant: "default", onClick: (e) => {
                                e.preventDefault();
                                setInternalSelectedCollections((prev) => prev.filter((c) => c.collectionId !== c.collectionId &&
                                    c.uuid !== c.uuid));
                                onUnSelect(c.collectionId, c.uuid, c.name);
                            } },
                            react.createElement(check/* default */.A, { width: 20, height: 20 })))))))))),
        react.createElement("div", { className: "flex justify-between gap-5" },
...
const CollectionConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: (open) => setDialogOpen(open), onOpenChangeComplete: (open) => {
        ...
        react.createElement(DialogContent, null,
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Choose Collections")),
...
const SkuConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: (open) => setDialogOpen(open), onOpenChangeComplete: (open) => {
        ...
        react.createElement(DialogContent, { className: 'max-w-[80vw]' },
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Select Products by SKU")),
        ...
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    ...
                    react.createElement(TableHead, null, " "))),
            react.createElement(TableBody, null, fields.map((product, index) => {
                var _a, _b;
                return (react.createElement(TableRow, { key: product.id },
                    react.createElement(TableCell, null, product.editable ? (react.createElement(SelectField, { name: `target_products.products.${index}.key`, wrapperClassName: "form-field mb-0", defaultValue: product.key, disabled: !product.editable, options: options.map((option) => ({
                            value: option.key,
                            label: option.label
                        })) })) : (react.createElement(react.Fragment, null,
                        ...
                        react.createElement(InputField, { name: `target_products.products.${index}.keylabel`, readOnly: true, wrapperClassName: "form-field mb-0", value: ((_a = options.find((c) => c.key === product.key)) === null || _a === void 0 ? void 0 : _a.label) ||
                                'Unknown' })))),
                    react.createElement(TableCell, null, product.editable ? (react.createElement(SelectField, { name: `target_products.products.${index}.operator`, defaultValue: product.operator, options: operators.map((operator) => ({
                            value: operator.key,
                        ...
                        react.createElement(InputField, { name: `target_products.products.${index}.operatorlabel`, type: "text", readOnly: true, wrapperClassName: "form-field mb-0", value: ((_b = operators.find((c) => { var _a; return c.key === ((_a = fieldWatch[index]) === null || _a === void 0 ? void 0 : _a.operator); })) === null || _b === void 0 ? void 0 : _b.label) || 'Unknown' })))),
                    react.createElement(TableCell, null,
                    ...
                    react.createElement(TableCell, null,
                        react.createElement("a", { href: "#", className: "text-destructive", onClick: (e) => {
                                e.preventDefault();
                                remove(index);
                            } },
                            react.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1.5rem", height: "1.5rem", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2 },
...
function TargetProducts({ products, maxQty }) {
    ...
    return (react.createElement(Item, { variant: 'outline', className: "mt-6" },
        react.createElement(ItemContent, null,
            react.createElement(ItemTitle, null, "Target Products"),
...
function DateField({ name, label, error, wrapperClassName, helperText, required, validation, className, min, max, defaultValue, ...props }) {
    const { control, formState: { errors } } = (0,index_esm/* useFormContext */.xW)();
    const fieldError = getNestedError(name, errors, error);
    const fieldId = `field-${name}`;
    ...
    return (react.createElement(Field, { "data-invalid": fieldError ? 'true' : 'false', className: wrapperClassName },
        label && (react.createElement(FieldLabel, { htmlFor: fieldId },
            react.createElement(react.Fragment, null,
                ...
                required && react.createElement("span", { className: "text-destructive" }, "*"),
                helperText && react.createElement(Tooltip, { content: helperText, position: "top" })))),
        react.createElement(index_esm/* Controller */.xI, { name: name, control: control, defaultValue: defaultValue, rules: validationRules, render: ({ field }) => {
                var _a;
                return (react.createElement(InputGroup, null,
                    react.createElement(InputGroupInput, { ...field, value: (_a = field.value) !== null && _a !== void 0 ? _a : '', id: fieldId, type: "date", min: min, max: max, className: className, "aria-invalid": fieldError !== undefined ? 'true' : 'false', "aria-describedby": fieldError !== undefined ? `${fieldId}-error` : undefined, ...props })));
            } }),
        fieldError && react.createElement(FieldError, null, fieldError)));
}
...
function General({ coupon }) {
    return (react.createElement(common_Area, { id: "couponFormGeneral", className: "space-y-3", coreComponents: [
            {
                component: {
        ...
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    ...
                    react.createElement(TableHead, null, " "))),
            react.createElement(TableBody, null, fields.map((p, i) => {
                var _a, _b;
                return (react.createElement(TableRow, { key: p.id },
                    react.createElement(TableCell, null, p.editable ? (react.createElement(SelectField, { name: `condition.required_products.${i}.key`, defaultValue: p.key, options: options.map((option) => ({
                            value: option.key,
                            label: option.label
                    ...
                    react.createElement(TableCell, null, p.editable ? (react.createElement(SelectField, { options: operators.map((operator) => ({
                            value: operator.key,
                            label: operator.label
                        ...
                        react.createElement(InputField, { readOnly: true, name: `condition.required_products.${i}.operatorlabel`, value: ((_b = operators.find((c) => { var _a; return c.key === ((_a = fieldsWatch[i]) === null || _a === void 0 ? void 0 : _a.operator); })) === null || _b === void 0 ? void 0 : _b.label) || 'Unknown', wrapperClassName: "form-field mb-0" })))),
                    react.createElement(TableCell, null,
        ...
        react.createElement("div", { className: "grid grid-cols-1 gap-5" },
            react.createElement(Card, null,
                react.createElement(CardHeader, null,
                    ...
                    react.createElement(CardDescription, null, "The general information about the coupon.")),
                react.createElement(CardContent, null,
                    react.createElement(common_Area, { id: "couponEditGeneral", noOuter: true }))),
            react.createElement(Card, null,
                react.createElement(CardHeader, null,
                    react.createElement(CardTitle, null, "Discount Type"),
                    react.createElement(CardDescription, null, "The type of discount applied by the coupon.")),
                react.createElement(CardContent, null,
            ...
            react.createElement("div", { className: "grid grid-cols-3 gap-x-5 grid-flow-row " },
                react.createElement("div", { className: "col-span-2 grid grid-cols-1 gap-5 auto-rows-max" },
                    react.createElement(Card, null,
                        react.createElement(CardHeader, null,
                            react.createElement(CardTitle, null, "Order conditions"),
                            react.createElement(CardDescription, null, "The conditions related to the order for the coupon to be applied.")),
                        react.createElement(CardContent, null,
                ...
                react.createElement("div", { className: "col-span-1 grid grid-cols-1 gap-5 auto-rows-max" },
                    react.createElement(Card, null,
                        react.createElement(CardHeader, null,
                            react.createElement(CardTitle, null, "Customer conditions"),
                            react.createElement(CardDescription, null, "The conditions related to the customer for the coupon to be applied.")),
                        react.createElement(CardContent, null,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(55972)))
