...
const Province = ({ selectedCountry = 'US', selectedProvince, allowedCountries = [], fieldName = 'storeProvince' }) => {
    ...
    if (fetching)
        return (react.createElement("div", { className: "flex flex-col gap-3" },
            react.createElement(Skeleton, { className: "w-1/2 h-5 rounded-md" }),
            react.createElement(Skeleton, { className: "w-full h-9 rounded-md" })));
    if (error) {
...
const Country = ({ selectedCountry, setSelectedCountry, allowedCountries = [], fieldName = 'storeCountry' }) => {
    ...
    if (fetching)
        return (react.createElement(Item, { variant: 'outline' },
            react.createElement(admin_Spinner, { width: '2rem', height: '2rem' })));
    if (error) {
        return react.createElement("p", { className: "text-destructive" }, error.message);
    }
                ...
                react.createElement(Form, { method: "POST", id: "storeSetting", action: saveSettingApi },
                    react.createElement(Card, null,
                        react.createElement(CardHeader, null,
                            react.createElement(CardTitle, null, "Store Settings"),
                            react.createElement(CardDescription, null, "Configure your store information")),
                        react.createElement(CardContent, null,
                            react.createElement(common_Area, { id: "storeInfoSetting", className: "space-y-3", coreComponents: [
                                    {
                                        component: {
                        ...
                        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
                            react.createElement(CardTitle, null, "Contact Information"),
                        ...
                        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
                            react.createElement(CardTitle, null, "Address"),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(84631)))
