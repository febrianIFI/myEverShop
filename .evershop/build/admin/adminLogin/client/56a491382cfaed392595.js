...
const SubmitButton = () => {
    ...
    return (react.createElement("div", { className: "form-submit-button flex border-t border-border mt-4 pt-4 justify-between" },
        react.createElement(Button_Button, { type: "submit", size: "lg", isLoading: isSubmitting }, "SIGN IN")));
};
function LoginForm({ authUrl, dashboardUrl }) {
    ...
    return (react.createElement("div", { className: "admin-login-form" },
      ...
      `),
        ...
        error && react.createElement("div", { className: "text-destructive py-2" }, error),
        react.createElement(Form, { action: authUrl, method: "POST", id: "adminLoginForm", onSuccess: onSuccess, submitBtn: false },
            react.createElement(common_Area, { id: "adminLoginForm", className: "space-y-3", coreComponents: [
                    {
                        component: {
                            default: (react.createElement(EmailField, { prefixIcon: react.createElement(mail/* default */.A, { className: "h-5 w-5" }), label: "Email", name: "email", placeholder: "Email", required: true, validation: {
                    ...
                    {
                        component: {
                            default: (react.createElement(PasswordField, { prefixIcon: react.createElement(lock_keyhole/* default */.A, { className: "h-5 w-5" }), label: "Password", name: "password", placeholder: "Password", required: true, validation: {
                    ...
                    {
                        component: {
                            default: react.createElement(SubmitButton, null)
                        },
                        sortOrder: 30
                    }
                ] }))));
...
var separator_Separator = __webpack_require__(44657);
...
function DropdownMenuSeparator({ className, ...props }) {
    return (react.createElement(separator_Separator/* Separator */.w, { "data-slot": "dropdown-menu-separator", className: cn('bg-border -mx-1 my-1 h-px', className), ...props }));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(79535)))
