...
function General({ widget, routes }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardContent, null,
            react.createElement(InputField, { name: "name", defaultValue: widget === null || widget === void 0 ? void 0 : widget.name, label: "Name", required: true, validation: { required: 'Name is required' }, placeholder: "Name" })),
        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
            react.createElement(RadioGroupField, { name: "status", label: "Status", defaultValue: widget === null || widget === void 0 ? void 0 : widget.status, required: true, validation: { required: 'Status is required' }, options: [
                    { value: 0, label: 'Disabled' },
                    { value: 1, label: 'Enabled' }
                ] })),
        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
            react.createElement("div", { role: "group", "data-slot": "field", "data-orientation": "vertical", className: "data-[invalid=true]:text-destructive gap-3 group/field flex w-full flex-col [&>*]:w-full [&>.sr-only]:w-auto" },
                react.createElement("label", { "data-slot": "field-label", className: "text-sm font-medium group-data-[disabled=true]:opacity-50 peer-disabled:opacity-50 items-center select-none group-data-[disabled=true]:pointer-events-none peer-disabled:cursor-not-allowed has-data-checked:bg-primary/5 has-data-checked:border-primary dark:has-data-checked:bg-primary/10 gap-1 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-3 group/field-label peer/field-label flex w-fit leading-snug has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col" }, "Areas"),
        ...
        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
            react.createElement("div", { role: "group", "data-slot": "field", "data-orientation": "vertical", className: "data-[invalid=true]:text-destructive gap-3 group/field flex w-full flex-col [&>*]:w-full [&>.sr-only]:w-auto" },
                react.createElement("label", { "data-slot": "field-label", className: "text-sm font-medium group-data-[disabled=true]:opacity-50 peer-disabled:opacity-50 items-center select-none group-data-[disabled=true]:pointer-events-none peer-disabled:cursor-not-allowed has-data-checked:bg-primary/5 has-data-checked:border-primary dark:has-data-checked:bg-primary/10 gap-1 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-3 group/field-label peer/field-label flex w-fit leading-snug has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col" }, "Pages"),
        ...
        react.createElement(CardContent, { className: "pt-3 border-t border-border" },
            react.createElement(NumberField, { name: "sort_order", label: "Sort Order", defaultValue: widget === null || widget === void 0 ? void 0 : widget.sortOrder, placeholder: "Sort Order", validation: {
...
function Setting({ type }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Widget Settings"),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(41670)))
