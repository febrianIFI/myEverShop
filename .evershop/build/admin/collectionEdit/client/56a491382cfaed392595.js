    ...
    return (react.createElement(Dialog, null,
        react.createElement(Card, null,
            react.createElement(CardHeader, null,
                ...
                react.createElement(CardDescription, null, "Manage the products assigned to this collection."),
        ...
        react.createElement(DialogContent, { className: "sm:max-w-[90vw] lg:max-w-200" },
            react.createElement(DialogHeader, null,
                ...
                react.createElement(Dialog_DialogDescription, null, "Select products to add to this collection.")),
            data && (react.createElement(ProductSelector, { onSelect: addProductFunction, selectedProducts: data.collection.products.items.map((p) => ({
                    sku: p.sku,
                    uuid: p.uuid,
...
function General({ collection }) {
    const fields = [
        ...
        {
            component: {
                default: (react.createElement(InputField, { name: "code", label: "Collection Code", defaultValue: (collection === null || collection === void 0 ? void 0 : collection.code) || '', required: true, validation: {
    ...
    return (react.createElement(Card, { title: "General" },
        react.createElement(CardHeader, null,
            ...
            react.createElement(CardDescription, null, "Manage general information about the collection.")),
        react.createElement(CardContent, null,
            react.createElement(common_Area, { id: "collectionEditGeneral", coreComponents: fields, className: "space-y-2" }))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(2333)))
