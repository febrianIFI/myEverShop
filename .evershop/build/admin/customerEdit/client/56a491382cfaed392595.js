...
function FullName({ fullName }) {
    return (react.createElement(CardContent, null,
        react.createElement(CardTitle, { className: "mb-2" }, "Full Name"),
        react.createElement("div", null,
...
function Group({ group }) {
    return (react.createElement(CardContent, { className: "pt-3 border-t border-border" },
        react.createElement(CardTitle, { className: "mb-2" }, "Group"),
        react.createElement("div", null,
...
function Email({ email }) {
    return (react.createElement(CardContent, { className: "pt-3 border-t border-border" },
        react.createElement(CardTitle, { className: "mb-2" }, "Email"),
        react.createElement("div", null,
...
function Status({ status }) {
    return (react.createElement(CardContent, { className: "pt-3 border-t border-border" },
        react.createElement(CardTitle, { className: "mb-2" }, "Status"),
        react.createElement("div", null,
...
function General({ customer }) {
    return (react.createElement(Card, null,
        react.createElement(common_Area, { id: "customerEditInformation", className: "space-y-3", coreComponents: [
                {
                    component: {
...
function OrderHistory({ customer: { orders = [] } }) {
    return (react.createElement(Card, { title: "Order History" },
        react.createElement(CardHeader, null,
            ...
            react.createElement(CardDescription, null, "Recently placed orders by this customer")),
        orders.length < 1 && (react.createElement(CardContent, null,
            react.createElement("div", null, "Customer does not have any order yet."))),
        orders.length > 0 && (react.createElement(react.Fragment, null, orders.map((order) => (react.createElement(CardContent, { key: order.uuid },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(34152)))
