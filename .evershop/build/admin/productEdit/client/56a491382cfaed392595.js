...
function Collections({ product: { collections } }) {
    return (react.createElement(Card, { className: "bg-popover" },
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Collections"),
            react.createElement(CardDescription, null, "Manage the collections associated with this product.")),
        react.createElement(CardContent, { className: "space-y-2" },
            collections.map((collection) => (react.createElement("div", { className: "flex justify-start gap-2 items-center align-middle", key: collection.uuid },
                react.createElement(tag/* default */.A, { width: 16, height: 16 }),
...
const FormButton = ({ cancelUrl, formId }) => {
    ...
    return (react.createElement("div", { className: "form-submit-button flex border-t border-border mt-4 pt-4 justify-between" },
        react.createElement(Button_Button, { size: 'lg', variant: "destructive", onClick: () => {
...
const New = ({ currentProductUuid, createVariantGroupApi, setGroup }) => {
    ...
    return (react.createElement(react.Fragment, null,
        ...
        action === 'create' && (react.createElement(CardContent, null,
            react.createElement("a", { className: "text-destructive hover:underline", href: "#", onClick: (e) => {
                    e.preventDefault();
                    setAction(undefined);
                } }, "Cancel")))));
};
//# sourceMappingURL=New.js.map
;// ./node_modules/@evershop/evershop/dist/components/common/ui/Table.js
/* unused harmony import specifier */ var Table_cn;
/* unused harmony import specifier */ var Table_React;


function Table({ className, ...props }) {
    return (react.createElement("div", { "data-slot": "table-container", className: "relative w-full" },
...
function TableFooter({ className, ...props }) {
    return (Table_React.createElement("tfoot", { "data-slot": "table-footer", className: Table_cn('bg-muted/50 border-t font-medium [&>tr]:last:border-b-0', className), ...props }));
}
function TableRow({ className, ...props }) {
    return (react.createElement("tr", { "data-slot": "table-row", className: cn('hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors border-border', className), ...props }));
}
function TableHead({ className, ...props }) {
    return (react.createElement("th", { "data-slot": "table-head", className: cn('text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0', className), ...props }));
}
...
function TableCaption({ className, ...props }) {
    return (Table_React.createElement("caption", { "data-slot": "table-caption", className: Table_cn('text-muted-foreground mt-4 text-sm', className), ...props }));
}
...
// EXTERNAL MODULE: ./node_modules/@base-ui/react/esm/dialog/description/DialogDescription.js
var DialogDescription = __webpack_require__(42468);
...
function Dialog_DialogClose({ ...props }) {
    return react.createElement(DialogClose/* DialogClose */.H, { "data-slot": "dialog-close", ...props });
}
...
function DialogFooter({ className, showCloseButton = false, children, ...props }) {
    return (react.createElement("div", { "data-slot": "dialog-footer", className: cn('gap-2 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end', className), ...props },
        children,
        showCloseButton && (react.createElement(DialogClose/* DialogClose */.H, { render: react.createElement(Button_Button, { variant: "outline" }) }, "Close"))));
}
...
function Dialog_DialogDescription({ className, ...props }) {
    return (react.createElement(DialogDescription/* DialogDescription */.r, { "data-slot": "dialog-description", className: cn('text-muted-foreground *:[a]:hover:text-foreground text-sm *:[a]:underline *:[a]:underline-offset-3', className), ...props }));
}
...
const Upload = ({ imageUploadUrl, targetPath, onUpload, isSingleMode }) => {
    ...
    return (react.createElement("div", { className: "uploader grid-item" },
        react.createElement("div", { className: "uploader-icon text-primary w-full h-full" },
            react.createElement("label", { htmlFor: id, className: "w-full h-full flex items-center justify-center cursor-pointer" }, uploading ? (react.createElement(admin_Spinner, { width: isSingleMode ? 40 : 25, height: isSingleMode ? 40 : 25 })) : (react.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor" },
                react.createElement("path", { fillRule: "evenodd", d: "M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 01-.707-.293l-1.121-1.121A2 2 0 0011.172 3H8.828a2 2 0 00-1.414.586L6.293 4.707A1 1 0 015.586 5H4zm6 9a3 3 0 100-6 3 3 0 000 6z", clipRule: "evenodd" }))))),
...
const ImageUploader_Image = ({ image, allowDelete, onDelete, isFirst, isSingleMode }) => {
    ...
    const classes = isSingleMode
        ...
        : `image border border-border rounded-lg grid-item ${isFirst ? 'first-item' : ''}`;
    return (react.createElement("div", { className: classes, id: image.uuid },
        react.createElement("div", { className: "img" },
            react.createElement("img", { src: image.url, alt: "" })),
        allowDelete && (react.createElement("span", { role: "button", tabIndex: 0, className: `remove cursor-pointer text-destructive fill-current ${isSingleMode ? 'single-mode-remove' : ''}`, onClick: async () => {
                setDeleting(true);
...
function ToggleField({ name, label, error, helperText, required, validation, wrapperClassName, disabled = false, defaultValue = false, trueValue = true, falseValue = false, trueLabel = 'Yes', falseLabel = 'No', size = 'default', onChange }) {
    const { control, formState: { errors } } = (0,index_esm/* useFormContext */.xW)();
    const fieldError = getNestedError(name, errors, error);
    const fieldId = `field-${name}`;
    const validationRules = {
    ...
    return (react.createElement(Field, { "data-invalid": fieldError ? 'true' : 'false', className: wrapperClassName },
        ...
        react.createElement(index_esm/* Controller */.xI, { name: name, control: control, rules: validationRules, defaultValue: defaultValue, render: ({ field }) => {
                ...
                return (react.createElement("div", { className: "flex items-center gap-3" },
                    react.createElement(Switch, { id: fieldId, size: size, checked: isActive, onCheckedChange: (checked) => {
                            const newValue = checked ? trueValue : falseValue;
                            field.onChange(newValue);
                            onChange === null || onChange === void 0 ? void 0 : onChange(newValue);
                        }, disabled: disabled, "aria-invalid": fieldError ? 'true' : 'false', "aria-describedby": fieldError ? `${fieldId}-error` : undefined }),
                    react.createElement("span", { className: "text-sm text-muted-foreground" }, isActive ? trueLabel : falseLabel)));
            } }),
        fieldError && (react.createElement(FieldError, { id: `${fieldId}-error` }, fieldError))));
}
...
`;
const VariantModal = ({ variant, variantGroup, createProductApi }) => {
    var _a, _b, _c;
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement("div", { className: "grid grid-cols-2 gap-x-5" },
            ...
            react.createElement("div", { className: "col-span-1" },
                react.createElement("div", { className: "grid grid-cols-2 gap-x-2 border-b border-border pb-4 mb-4" }, data.attributes.items.map((a) => {
                    var _a;
                    return (react.createElement("div", { key: a.attributeCode, className: "mt-2 col" },
                        react.createElement(SelectField, { name: `variant_attributes.${a.attributeCode}`, label: a.attributeName, placeholder: "Select an option", required: true, validation: {
                ...
                react.createElement("div", { className: "grid grid-cols-3 gap-x-2 border-b border-border pb-4 mb-4" },
                    react.createElement("div", null,
                        react.createElement(InputField, { name: "variant_sku", label: "Sku", placeholder: "Enter SKU", required: true, validation: {
                                required: 'SKU is required'
                            }, defaultValue: (_a = variant === null || variant === void 0 ? void 0 : variant.product) === null || _a === void 0 ? void 0 : _a.sku })),
                    react.createElement("div", null,
                        react.createElement(NumberField, { name: "variant_qty", label: "Quantity", required: true, placeholder: "Enter quantity", validation: {
                                required: 'Qty is required'
                            }, allowDecimals: false, defaultValue: ((_c = (_b = variant === null || variant === void 0 ? void 0 : variant.product) === null || _b === void 0 ? void 0 : _b.inventory) === null || _c === void 0 ? void 0 : _c.qty) || 0 }))),
                react.createElement("div", { className: "grid grid-cols-3 gap-x-2" },
                    react.createElement("div", null,
                        react.createElement(ToggleField, { name: "variant_status", label: "Status", trueValue: true, falseValue: false, defaultValue: (variant === null || variant === void 0 ? void 0 : variant.product.status) === 1 })),
                    react.createElement("div", null,
                        react.createElement(ToggleField, { name: "variant_visibility", label: "Visibility", trueValue: true, falseValue: false, defaultValue: (variant === null || variant === void 0 ? void 0 : variant.product.visibility) === 1 }))))),
        react.createElement(DialogFooter, null,
            react.createElement(Dialog_DialogClose, null,
                react.createElement(Button_Button, { variant: "outline" }, "Cancel")),
            react.createElement(Button_Button, { isLoading: saving, onClick: async () => {
...
const CreateVariant = ({ variantGroup, createProductApi }) => {
    return (react.createElement("div", { className: "mt-3" },
        react.createElement(Dialog, null,
            react.createElement(Dialog_DialogTrigger, null,
                react.createElement(Button_Button, { variant: 'outline' }, "Add Variant")),
            react.createElement(DialogContent, { className: 'sm:max-w-212.5' },
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, "New Variant"),
                    react.createElement(Dialog_DialogDescription, null, "Create a new variant for this product.")),
                react.createElement(VariantModal, { variantGroup: variantGroup, createProductApi: createProductApi })))));
};
...
const SkeletonRow = () => (react.createElement(TableRow, null,
...
const Skeleton = ({ rows = 5, className = '' }) => {
    return (react.createElement("div", { className: `w-full ${className}` },
        react.createElement(Table, null,
            react.createElement(TableBody, null, Array.from({ length: rows }, (_, index) => (react.createElement(SkeletonRow, { key: index })))))));
};
...
var cog = __webpack_require__(57106);
...
const EditVariant = ({ variant, variantGroup }) => {
    return (react.createElement("div", null,
        react.createElement(Dialog, null,
            react.createElement(Dialog_DialogTrigger, null,
                react.createElement(Button_Button, { variant: 'link', className: 'hover:cursor-pointer' },
                    react.createElement(cog/* default */.A, { className: "w-5 h-5 text-primary" }))),
            react.createElement(DialogContent, { className: 'sm:max-w-212.5' },
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, "Edit Variant"),
                    react.createElement(Dialog_DialogDescription, null, "Update the variant details and attributes here.")),
                react.createElement(VariantModal, { variant: variant, variantGroup: variantGroup })))));
};
...
const Variant = ({ variant, refresh, variantGroup }) => {
    ...
    return (react.createElement(TableRow, null,
        react.createElement(TableCell, null,
            react.createElement(Item, { variant: 'outline', size: 'xs' },
                react.createElement(ItemContent, null, ((_b = (_a = variant.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.url) ? (react.createElement("img", { style: { maxWidth: '50px', height: 'auto' }, src: (_d = (_c = variant === null || variant === void 0 ? void 0 : variant.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.url, alt: "" })) : (react.createElement(ProductNoThumbnail, { className: "size-12" }))))),
        ...
        react.createElement(TableCell, null,
            react.createElement(Button_Button, { variant: 'link', className: 'hover:cursor-pointer', onClick: (e) => {
                    e.preventDefault();
                    window.location.href = variant.product.editUrl;
                } }, (_e = variant.product) === null || _e === void 0 ? void 0 : _e.sku)),
        react.createElement(TableCell, null, (_h = (_g = (_f = variant.product) === null || _f === void 0 ? void 0 : _f.price) === null || _g === void 0 ? void 0 : _g.regular) === null || _h === void 0 ? void 0 : _h.text),
        react.createElement(TableCell, null, (_k = (_j = variant.product) === null || _j === void 0 ? void 0 : _j.inventory) === null || _k === void 0 ? void 0 : _k.qty),
        react.createElement(TableCell, null, ((_l = variant.product) === null || _l === void 0 ? void 0 : _l.status) === 1 ? (react.createElement("span", { className: "text-primary font-medium" }, "Enabled")) : (react.createElement("span", { className: "text-destructive font-medium" }, "Disabled"))),
        react.createElement(TableCell, null,
            ...
            react.createElement(Table, null,
                react.createElement(TableHeader, null,
                    react.createElement(TableRow, null,
                        react.createElement(TableHead, null, "Image"),
                        variantGroup.attributes.map((attribute) => (react.createElement(TableHead, { key: attribute.attributeId }, attribute.attributeName))),
                ...
                react.createElement(TableBody, null, (((_a = data.product.variantGroup) === null || _a === void 0 ? void 0 : _a.items) || [])
...
const VariantGroup = ({ product, createVariantGroupApi, createProductApi }) => {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Variant Group"),
            react.createElement(CardDescription, null, "Manage the variant group of the product.")),
...
function ReactSelectField({ name, label, error, wrapperClassName = 'form-field', helperText, required, validation, options, className, isMulti = false, defaultValue, ...selectProps }) {
    ...
    return (react.createElement(Field, { "data-invalid": fieldError ? 'true' : 'false', className: wrapperClassName, id: `field-${name}` },
        label && (react.createElement(FieldLabel, { htmlFor: fieldId },
            react.createElement(react.Fragment, null,
                label,
                required && react.createElement("span", { className: "text-destructive" }, "*"),
                helperText && react.createElement(Tooltip, { content: helperText, position: "top" })))),
        react.createElement(index_esm/* Controller */.xI, { name: name, control: control, rules: validationRules, defaultValue: defaultValue, render: ({ field }) => (react.createElement(react_select_esm/* default */.Ay, { ...field, ...selectProps, inputId: fieldId, options: options, isMulti: isMulti, className: cn(className), value: isMulti
                    ? options.filter((option) => { var _a; return (_a = (field.value || defaultValue || [])) === null || _a === void 0 ? void 0 : _a.includes(option.value); })
                ...
                }, classNamePrefix: "react-select", "aria-invalid": fieldError !== undefined ? 'true' : 'false', "aria-describedby": fieldError !== undefined ? `${fieldId}-error` : undefined, classNames: {
                    control: (state) => cn('min-h-auto border border-input rounded-md shadow-xs transition-[color,box-shadow]', state.isFocused && 'border-ring ring-[3px] ring-ring/50', fieldError &&
...
function Attributes({ product, groups: { items } }) {
    ...
    const { fields, remove, append } = (0,index_esm/* useFieldArray */.jz)({
        name: 'attributes'
    });
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Attribute group"),
            react.createElement(CardDescription, null, "Manage the attributes.")),
        react.createElement(CardContent, null,
            react.createElement("div", null,
...
function SimplePagination({ total, count, page, hasNext, setPage }) {
    return (react.createElement("div", { className: "simple__pagination flex gap-2 items-center" },
        ...
        react.createElement("div", { className: "flex gap-2" },
            page > 1 && (react.createElement("a", { className: "hover:text-interactive border rounded p-1.25 border-divider", href: "#", onClick: (e) => {
                    e.preventDefault();
                    setPage(page - 1);
                } },
                react.createElement(chevron_left/* default */.A, { width: 15, height: 15 }))),
            page === 1 && (react.createElement("span", { className: "border rounded p-1.25 border-divider text-divider" },
                react.createElement(chevron_left/* default */.A, { width: 15, height: 15 }))),
            hasNext && (react.createElement("a", { className: "hover:text-interactive border rounded p-1.25 border-divider", href: "#", onClick: (e) => {
                    e.preventDefault();
                    setPage(page + 1);
                } },
                react.createElement(chevron_right/* default */.A, { width: 15, height: 15 }))),
            !hasNext && (react.createElement("span", { className: "border rounded p-1.25 border-divider text-divider" },
                react.createElement(chevron_right/* default */.A, { width: 15, height: 15 }))))));
}
...
function Skeleton_Skeleton({ className, ...props }) {
...
const CategoryListSkeleton = () => {
    ...
    return (react.createElement("div", { className: "attribute-group-list-skeleton space-y-2 divide-y" }, skeletonItems.map((_, index) => (react.createElement("div", { key: index, className: "attribute-group-skeleton-item border-border pb-2 flex justify-between items-center " },
        react.createElement("div", { className: "flex items-center" },
            react.createElement(Skeleton_Skeleton, { className: "h-5 w-30 rounded" })),
        react.createElement("div", { className: "select-button" },
            react.createElement(Skeleton_Skeleton, { className: "h-6 w-12 rounded" })))))));
};
    ...
    return (react.createElement("div", null,
        react.createElement("div", null,
            react.createElement("div", { className: "p-2" },
                react.createElement(Input_Input, { type: "text", value: inputValue || '', placeholder: "Search categories", onChange: (e) => {
            ...
            !fetching && data && (react.createElement("div", { className: "divide-y" },
                ...
                data.categories.items.map((cat) => (react.createElement("div", { key: cat.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    ...
                    react.createElement("div", { className: "col-span-3 text-right" },
                        !isCategorySelected(cat, internalSelectedCategories) && (react.createElement(Button_Button, { variant: 'outline', onClick: async (e) => {
                                e.preventDefault();
                        ...
                        isCategorySelected(cat, internalSelectedCategories) && (react.createElement(Button_Button, { variant: 'default', onClick: (e) => {
                                e.preventDefault();
                                setInternalSelectedCategories((prev) => prev.filter((c) => c.categoryId !== cat.categoryId &&
                                    c.uuid !== cat.uuid));
                                onUnSelect(cat.categoryId, cat.uuid, cat.name);
                            } },
                            react.createElement(check/* default */.A, { className: "w-5 h-5" })))))))))),
    ...
    return (react.createElement("div", null,
        ...
        react.createElement("span", { className: "text-interactive pl-5" },
            ...
            react.createElement("a", { href: "#", onClick: (e) => {
                    e.preventDefault();
                    onUnassign();
                }, className: "text-destructive ml-5" }, "Unassign")),
...
const CategorySelect = ({ product }) => {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
        react.createElement("div", { className: "space-y-3" },
            react.createElement(Label, null, "Category"),
            category && (react.createElement("div", { className: "border rounded border-border p-2" },
                react.createElement(ProductCategory, { categoryId: category.categoryId, onChange: () => {
                        setDialogOpen(true);
                    }, onUnassign: () => setCategory(null) }))),
            !category && (react.createElement(Button_Button, { variant: "outline", size: "sm", onClick: (e) => {
                    e.preventDefault();
                    setDialogOpen(true);
                } }, "Select category")),
            react.createElement(DialogContent, null,
                react.createElement(DialogHeader, null,
                    react.createElement(Dialog_DialogTitle, null, "Select Category")),
...
function General({ product, setting, productTaxClasses: { items: taxClasses } }) {
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            ...
            react.createElement(CardDescription, null, "Manage the general information of the product.")),
        react.createElement(CardContent, null,
            react.createElement(common_Area, { id: "productEditGeneral", className: "flex flex-col gap-2", coreComponents: [
                    {
                        component: {
                    ...
                    {
                        component: {
                            default: (react.createElement(SKUAndPrice, { sku: (product === null || product === void 0 ? void 0 : product.sku) || '', price: (product === null || product === void 0 ? void 0 : product.price.regular) || {
                                    value: undefined
                                }, setting: setting }))
                        },
                        sortOrder: 20,
...
function Inventory({ product }) {
    ...
    return (react.createElement(Card, { className: "bg-popover" },
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Inventory"),
            react.createElement(CardDescription, null, "Manage the inventory settings of the product.")),
        react.createElement(CardContent, null,
        ...
        react.createElement(CardContent, { className: "border-t border-t-border pt-6" },
...
function Media({ product }) {
    ...
    return (react.createElement(Card, { title: "Media" },
        react.createElement(CardHeader, null,
            ...
            react.createElement(CardDescription, null, "Manage product images and gallery. Drag and drop to reorder images.")),
        react.createElement(CardContent, null,
...
function SEO({ product }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "SEO"),
            react.createElement(CardDescription, null, "Manage the SEO settings.")),
        react.createElement(CardContent, null,
            react.createElement(common_Area, { id: "productEditSeo", coreComponents: fields, className: "flex flex-col gap-2" }))));
}
const Seo_layout = {
    areaId: 'leftSide',
    sortOrder: 60
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit+productNew/Shipping.js





function Shipping({ product, setting }) {
    var _a, _b;
    ...
    const noShippingRequired = (0,index_esm/* useWatch */.FH)({
        control,
        name: 'no_shipping_required',
        defaultValue: (shipping.noShippingRequired !== null && shipping.noShippingRequired) ||
            false
    });
    return (react.createElement(Card, null,
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Shipping"),
            react.createElement(CardDescription, null, "Manage the shipping settings of the product.")),
        react.createElement(CardContent, null,
            react.createElement(CheckboxField, { name: "no_shipping_required", label: "No shipping required?", defaultValue: shipping.noShippingRequired === true, helperText: "Select this option if the product is a digital product or service that does not require shipping.", wrapperClassName: "mb-0" })),
        react.createElement(CardContent, null,
            !noShippingRequired && (react.createElement(NumberField, { name: "weight", placeholder: "Enter weight", label: `Weight`, defaultValue: (_a = shipping.weight) === null || _a === void 0 ? void 0 : _a.value, unit: setting === null || setting === void 0 ? void 0 : setting.weightUnit, required: true, validation: {
                    min: {
                        value: 0,
                        message: 'Weight must be a positive number'
                    }
                }, helperText: 'Weight must be a positive number' })),
            noShippingRequired && (react.createElement(NumberField, { name: "weight_no_shipping", placeholder: "Enter weight", label: `Weight`, defaultValue: (_b = shipping.weight) === null || _b === void 0 ? void 0 : _b.value, unit: setting === null || setting === void 0 ? void 0 : setting.weightUnit, disabled: true, helperText: 'Weight must be a positive number' })))));
}
const Shipping_layout = {
    areaId: 'rightSide',
    sortOrder: 15
};
const Shipping_query = (/* unused pure expression or super */ null && (`
  query Query {
    product(id: getContextValue("productId", null)) {
      weight {
        value
...
function Status({ product }) {
    return (react.createElement(Card, { className: "bg-popover" },
        react.createElement(CardHeader, null,
            react.createElement(CardTitle, null, "Product Status"),
            react.createElement(CardDescription, null, "Set the status and visibility of the product.")),
        react.createElement(CardContent, null,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(88866)))
