...
function CMSPageGrid({ cmsPages: { items: pages, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "pageGridFilter" },
        ...
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    pages.map((p, i) => (react.createElement(TableRow, { key: i },
            ...
            pages.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no page to display")),
...
function NewPageButton({ newPageUrl }) {
    return (react.createElement(Button_Button, { onClick: () => (window.location.href = newPageUrl) }, "New Page"));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(59254)))
