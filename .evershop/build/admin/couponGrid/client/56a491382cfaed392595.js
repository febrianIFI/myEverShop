...
/* unused harmony import specifier */ var ButtonGroup_mergeProps;
/* unused harmony import specifier */ var ButtonGroup_useRender;
...
function ButtonGroupText({ className, render, ...props }) {
    return ButtonGroup_useRender({
        defaultTagName: 'div',
        props: ButtonGroup_mergeProps({
...
function Actions({ coupons = [], selectedIds = [] }) {
    ...
    return (react.createElement(TableRow, null,
        ...
        selectedIds.length > 0 && (react.createElement(TableCell, { colSpan: "100" },
...
function CouponGrid({ coupons: { items: coupons, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(CardHeader, { className: "flex justify-between" },
            react.createElement(Form, { submitBtn: false, id: "couponGridFilter" },
                    ...
                    react.createElement(common_Area, { id: "couponGridFilter", noOuter: true, coreComponents: [
                            ...
                            },
                            {
                                component: {
                                    default: () => {
                                        var _a;
                                        return (react.createElement(Select, { value: (_a = currentFilters.find((f) => f.key === 'free_shipping')) === null || _a === void 0 ? void 0 : _a.value, onValueChange: (value) => {
                                                const url = new URL(document.location);
                                                url.searchParams.set('free_shipping', value);
                                                window.location.href = url.href;
                                            } },
                                            react.createElement(Select_SelectTrigger, null,
                                                react.createElement(Select_SelectValue, null, "Free shipping ?")),
                                            react.createElement(SelectContent, null,
                                                react.createElement(Select_SelectGroup, null,
                                                    react.createElement(SelectLabel, null, "Free shipping ?"),
                                                    react.createElement(Select_SelectItem, { value: "1" }, "Free shipping"),
                                                    react.createElement(Select_SelectItem, { value: "0" }, "No free shipping")))));
                                    }
                                },
                                sortOrder: 10
                            }
            ...
            react.createElement(CardAction, null,
                react.createElement(Button_Button, { variant: "link", onClick: () => {
                        const url = new URL(document.location);
                        url.search = '';
                        window.location.href = url.href;
                    } }, "Clear filter"))),
        react.createElement(CardContent, null,
            react.createElement(Table, null,
                ...
                react.createElement(TableBody, null,
                    ...
                    coupons.map((c) => (react.createElement(TableRow, { key: c.couponId },
                        react.createElement(TableHead, null,
                            react.createElement("div", { className: "form-field mb-0" },
                                react.createElement(Checkbox, { checked: selectedRows.includes(c.uuid), onCheckedChange: (checked) => {
                                        if (checked) {
                        ...
                        react.createElement(common_Area, { id: "couponGridRow", row: c, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                                ...
                                },
                                {
                                    component: {
                                        default: () => {
                                            var _a;
                                            return (react.createElement(TableCell, null, ((_a = c.startDate) === null || _a === void 0 ? void 0 : _a.text) || '--'));
                                        }
                                    },
                                    sortOrder: 20
                                },
                                {
                                    component: {
                                        default: () => {
                                            var _a;
                                            return (react.createElement(TableCell, null, ((_a = c.endDate) === null || _a === void 0 ? void 0 : _a.text) || '--'));
                                        }
                                    },
                                    sortOrder: 30
                                },
                                ...
                                {
                                    component: {
                                        default: ({ areaProps }) => (react.createElement(TableCell, null, c.usedTime))
                                    },
                                    sortOrder: 50
                                }
                            ] })))))),
            coupons.length === 0 && (react.createElement("div", { className: "flex w-full justify-center mt-2" }, "There is no coupon to display")),
...
function NewCouponButton({ newCouponUrl }) {
    return (react.createElement(Button_Button, { onClick: () => (window.location.href = newCouponUrl), title: "New Coupon" },
        ' ',
        "New Coupon",
        ' '));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(26783)))
