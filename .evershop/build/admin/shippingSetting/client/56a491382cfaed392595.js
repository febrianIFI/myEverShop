...
function SettingMenu() {
    return (react.createElement("div", { className: "setting-page-menu space-y-3" },
...
function ReactSelectCreatableField({ name, label, error, wrapperClassName = 'form-field', helperText, required, validation, options, className, isMulti = false, defaultValue, onCreateOption, formatCreateLabel = (inputValue) => `Create "${inputValue}"`, ...selectProps }) {
    const { control, unregister, formState: { errors } } = (0,index_esm/* useFormContext */.xW)();
    const fieldId = `field-${name}`;
    ...
    const fieldError = getNestedError(name, errors, error);
    return (react.createElement(index_esm/* Controller */.xI, { name: name, control: control, rules: validationRules, defaultValue: defaultValue, render: ({ field, fieldState }) => {
        ...
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    react.createElement(TableHead, { className: "border-none" }, "Min Price"),
                    react.createElement(TableHead, { className: "border-none" }, "Shipping Cost"),
                    react.createElement(TableHead, { className: "border-none" }, "Action"))),
            react.createElement(TableBody, null, fields.map((field, index) => (react.createElement(TableRow, { key: field.id, className: "border-border py-5" },
                ...
                react.createElement(TableCell, null, fields.length > 1 && (react.createElement("button", { type: "button", onClick: () => remove(index), className: "text-destructive" }, "Delete"))))))),
            react.createElement(TableFooter, { className: "border-border" },
                react.createElement(TableRow, null,
                    react.createElement(TableCell, { colSpan: 3, className: "border-none" },
                        react.createElement(Button_Button, { type: "button", size: 'sm', variant: 'outline', onClick: () => {
                                append({
...
function WeightBasedPrice({ lines }) {
    ...
    return (react.createElement("div", { className: "my-5" },
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, null,
                    react.createElement(TableHead, { className: "border-none" }, "Min Weight"),
                    react.createElement(TableHead, { className: "border-none" }, "Shipping Cost"),
                    react.createElement(TableHead, { className: "border-none" }, "Action"))),
            react.createElement(TableBody, null, fields.map((field, index) => (react.createElement(TableRow, { key: field.id, className: "border-divider py-5" },
                react.createElement(TableCell, { className: "border-none" },
                ...
                react.createElement(TableCell, { className: "border-none" }, fields.length > 1 && (react.createElement("button", { type: "button", onClick: () => remove(index), className: "text-destructive" }, "Delete"))))))),
            react.createElement(TableFooter, { className: "border-border" },
                react.createElement(TableRow, null,
                    react.createElement(TableCell, { colSpan: 3, className: "border-none" },
                        react.createElement(Button_Button, { type: "button", size: 'sm', variant: 'outline', onClick: () => {
...
function Condition({ method }) {
    ...
    return (react.createElement("div", { className: "pt-2 space-y-3" },
        react.createElement(Label, null, "Conditions"),
        react.createElement("div", null,
...
const CostSetting = ({ method }) => {
    ...
    return (react.createElement(react.Fragment, null,
        ...
        typeWatch === 'api' && (react.createElement(InputField, { name: "calculate_api", placeholder: "Calculate API endpoint", required: true, validation: { required: 'Calculate API is required' }, defaultValue: (method === null || method === void 0 ? void 0 : method.calculateApi) || '', helperText: "This is the ID of an internal api to calculate shipping cost." }))));
};
function MethodForm({ saveMethodApi, onSuccess, reload, method }) {
    ...
    const methodUpdateApi = method
        ? (_a = result.data.shippingMethods.find((m) => m.value === method.uuid)) === null || _a === void 0 ? void 0 : _a.updateApi
        : null;
    return (react.createElement(Form, { id: "shippingMethodForm", method: method ? 'PATCH' : 'POST', action: saveMethodApi, submitBtn: false, onError: (error) => {
        ...
        react.createElement("div", { className: "divide-y space-y-3" },
            react.createElement("div", { className: "border-border py-3 space-y-3" },
                !method ? (react.createElement(ReactSelectCreatableField, { name: "method_id", label: "Shipping Method", placeholder: "Select or create shipping method", isClearable: true, isDisabled: isLoading, isLoading: isLoading, onCreateOption: handleCreate, options: result.data.shippingMethods, required: true, validation: { required: 'Shipping method is required' } })) : (react.createElement("div", { className: "space-y-3" },
                    react.createElement("div", { className: "flex gap-2 items-end" },
                        react.createElement("div", { className: "flex-1" },
                            react.createElement(InputField, { name: "method_name", label: "Method name", placeholder: "Method name", required: true, defaultValue: (method === null || method === void 0 ? void 0 : method.name) || '', disabled: !shippingMethod.updatingName, validation: { required: 'Method name is required' } })),
                        react.createElement(Button_Button, { variant: shippingMethod.updatingName ? 'default' : 'outline', onClick: async (e) => {
                                e.preventDefault();
                                if (shippingMethod.updatingName === true) {
                                    if (!methodUpdateApi) {
                                        react_toastify_esm/* toast */.oR.error('Update API not found');
                                        return;
                                    }
                                    setIsLoading(true);
                                    ...
                                    if (response.ok) {
                                        ...
                                        react_toastify_esm/* toast */.oR.success('Method name updated successfully');
                                    }
                                    else {
                                        react_toastify_esm/* toast */.oR.error(data.error.message);
                                    }
                            ...
                            }, isLoading: isLoading }, shippingMethod.updatingName ? 'Save' : 'Edit name')))),
                react.createElement(ToggleField, { name: "is_enabled", label: "Status", trueLabel: "Enable", falseLabel: "Disable", defaultValue: (method === null || method === void 0 ? void 0 : method.isEnabled) || 0 }),
                method && (react.createElement(InputField, { type: "hidden", name: "method_id", defaultValue: (method === null || method === void 0 ? void 0 : method.uuid) || '' }))),
            react.createElement("div", { className: "border-border py-3 space-y-3" },
                react.createElement(RadioGroupField, { name: "calculation_type", label: "Calculation Type", options: [
                ...
                !hasCondition && (react.createElement(InputField, { name: "condition_type", type: "hidden", defaultValue: "none" })),
                hasCondition && react.createElement(Condition, { method: method }),
                react.createElement(Button_Button, { variant: hasCondition ? 'destructive' : 'outline', onClick: (e) => {
                        e.preventDefault();
                        setHasCondition(!hasCondition);
                    } }, hasCondition ? 'Remove condition' : 'Add condition')),
            react.createElement("div", { className: "border-border" },
                react.createElement("div", { className: "flex justify-end gap-2" },
                    react.createElement(Button_Button, { title: "Save", variant: "default", onClick: async () => {
                        ...
                        }, isLoading: isLoading, disabled: shippingMethod.updatingName }, "Save"))))));
}
...
function Method({ method, reload }) {
    ...
    return (react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
        react.createElement(react.Fragment, null,
            ...
            react.createElement("td", { className: "border-none py-2" }, method.isEnabled ? (react.createElement("span", { className: "text-green-700" }, "Enabled")) : (react.createElement("span", { className: "text-destructive" }, "Disabled"))),
            react.createElement("td", { className: "border-none py-2" }, ((_a = method.cost) === null || _a === void 0 ? void 0 : _a.text) || (react.createElement("a", { href: "#", className: "text-primary", onClick: (e) => {
                    e.preventDefault();
                    setDialogOpen(true);
                } },
                react.createElement(cog/* default */.A, { width: 22, height: 22 })))),
            ...
            react.createElement("td", { className: "border-none py-2" },
                react.createElement("a", { href: "#", className: "text-primary", onClick: (e) => {
                        e.preventDefault();
                        setDialogOpen(true);
                    } }, "Edit"),
                react.createElement("a", { href: "#", className: "text-destructive ml-5", onClick: async (e) => {
                        e.preventDefault();
                        try {
        ...
        react.createElement(DialogContent, null,
            react.createElement(DialogHeader, null,
                react.createElement(Dialog_DialogTitle, null, "Edit Shipping Method")),
            react.createElement(MethodForm, { saveMethodApi: method.updateApi, onSuccess: () => setDialogOpen(false), reload: reload, method: method }))));
}
...
function Methods({ reload, methods, addMethodApi }) {
    const [dialogOpen, setDialogOpen] = react.useState(false);
    return (react.createElement("div", { className: "my-5 text-xs" },
        react.createElement(Table, null,
            react.createElement(TableHeader, null,
                react.createElement(TableRow, { className: "text-xs" },
                    react.createElement(TableHead, { className: "border-none" }, "Method"),
                    react.createElement(TableHead, { className: "border-none" }, "Status"),
                    react.createElement(TableHead, { className: "border-none" }, "Cost"),
                    react.createElement(TableHead, { className: "border-none" }, "Condition"),
                    react.createElement(TableHead, { className: "border-none" }, "Action"))),
            react.createElement(TableBody, null, methods.map((method) => (react.createElement(TableRow, { key: method.methodId, className: "border-divider py-5 text-xs" },
        ...
        react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
            react.createElement("div", { className: "mt-2" },
                react.createElement(Dialog_DialogTrigger, null,
                    react.createElement(Button_Button, { variant: 'link', onClick: (e) => {
                            e.preventDefault();
                        } }, "+ Add Method"))),
            react.createElement(DialogContent, null,
                react.createElement(Dialog_DialogTitle, null, "Add Shipping Method"),
                react.createElement(MethodForm, { saveMethodApi: addMethodApi, onSuccess: () => {
                        setDialogOpen(false);
                    }, reload: reload })))));
}
...
function ZoneForm({ formMethod, saveZoneApi, onSuccess, reload, zone }) {
    ...
    react.useEffect(() => {
        var _a;
        if (countryWatch !== ((_a = zone === null || zone === void 0 ? void 0 : zone.country) === null || _a === void 0 ? void 0 : _a.code)) {
            form.setValue('provinces', []);
        }
    }, [countryWatch, (_b = zone === null || zone === void 0 ? void 0 : zone.country) === null || _b === void 0 ? void 0 : _b.code, form]);
    if (fetching)
        return react.createElement(admin_Spinner, { width: 20, height: 20 });
    if (error) {
        return react.createElement("p", { className: "text-destructive" }, "Error loading countries");
    }
    return (react.createElement(Form, { id: "createShippingZone", method: formMethod || 'POST', action: saveZoneApi, submitBtn: false, onSuccess: async () => {
            await reload();
            onSuccess();
        }, form: form },
        react.createElement("div", { className: "space-y-3" },
            react.createElement(InputField, { name: "name", label: "Zone Name", "aria-label": "Zone Name", placeholder: "Enter zone name", required: true, validation: { required: 'Zone name is required' }, defaultValue: zone === null || zone === void 0 ? void 0 : zone.name }),
            react.createElement(ReactSelectField, { name: "country", label: "Country", "aria-label": "Country", placeholder: "Select country", required: true, validation: { required: 'Country is required' }, options: data.countries, hideSelectedOptions: false, isMulti: false, defaultValue: (_c = zone === null || zone === void 0 ? void 0 : zone.country) === null || _c === void 0 ? void 0 : _c.code }),
            react.createElement(ReactSelectField, { name: "provinces", label: "Provinces/States", "aria-label": "Provinces/States", placeholder: "Select provinces/states", options: ((_d = data.countries.find((c) => c.value === countryWatch)) === null || _d === void 0 ? void 0 : _d.provinces) ||
            ...
            react.createElement("div", { className: "flex justify-end gap-2" },
                react.createElement(Button_Button, { title: "Save", variant: "default", onClick: () => {
...
function Zone({ zone, reload }) {
    var _a;
    const [dialogOpen, setDialogOpen] = react.useState(false);
    return (react.createElement(CardContent, { className: "space-y-3 pt-3 border-t border-border" },
        react.createElement("div", { className: "flex justify-between items-center gap-5" },
            react.createElement("div", { className: "text-xs uppercase font-semibold" }, zone.name),
            react.createElement("div", { className: "flex justify-between gap-5" },
                react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
                    react.createElement(Dialog_DialogTrigger, null, "Edit Zone"),
                    react.createElement(DialogContent, null,
                        react.createElement(DialogHeader, null,
                            react.createElement(Dialog_DialogTitle, null, "Edit Shipping Zone")),
                        react.createElement(ZoneForm, { formMethod: "PATCH", saveZoneApi: zone.updateApi, onSuccess: () => setDialogOpen(false), reload: reload, zone: zone }))),
                react.createElement("a", { className: "text-destructive", href: "#", onClick: async (e) => {
                        e.preventDefault();
                        try {
        ...
        react.createElement("div", { className: "divide-y border rounded border-divider" },
            react.createElement("div", { className: "flex justify-start items-center border-divider" },
                react.createElement("div", { className: "p-5" },
                    react.createElement(map_pin/* default */.A, { width: 20, height: 20 })),
                react.createElement("div", { className: "grow px-2" },
                    react.createElement("div", null,
...
function Zones({ createShippingZoneApi }) {
    ...
    if (fetching)
        return react.createElement(admin_Spinner, { width: '2rem', height: '2rem' });
    if (error)
        return react.createElement("div", { className: "text-destructive" }, "Error loading zones");
    ...
    return (react.createElement(react.Fragment, null,
        ...
        react.createElement(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen },
            react.createElement("div", { className: "flex justify-end pr-5" },
                react.createElement(Dialog_DialogTrigger, null,
                    react.createElement(Button_Button, null, "Create New Zone"))),
            react.createElement(DialogContent, null,
            ...
            react.createElement("div", { className: "col-span-4" },
                react.createElement(Card, null,
                    react.createElement(CardHeader, null,
                        ...
                        react.createElement(CardDescription, null, "Choose where you ship and how much you charge for shipping.")),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(96745)))
